...
export default class WebUI{
	 ...
	 */
	private start(configuration: UIConfigurationData){
	...
	**/
	private drawScreens() {
		...
		if(this.screens.length==0){
			var bodyElement = document.getElementsByTagName("BODY")[0];
			const uiElement = UIHTMLElement.get(bodyElement)
			if (uiElement != null) {
				this.uiPrepare.generateUIViews(uiElement, this.configuration, this.screens, null);
			}
		}
