...
function ha(a,b,c){M("prepare");U(a.view.children,b);S(a.view);N("prepare");M("core");var e=a.view;n=b;var d=R(e),f=Q(d),h;do{h=[];for(var k=1;k<d.length;k++)d[k].ma();for(k=0;k<e.i.length;k++)p(e.i[k],e,d,f,e.width,h);for(k=0;k<e.j.length;k++)w(e.j[k],e,d,f,e.height,h)}while(0<h.length);N("core");M("draw");e=J(a.view.children);a=a.view;d=e.X;f=document.getElementById(a.id);"s"!=a.id&&null!=f&&(f.style.width="s"==a.c?a.width+"px":"sp"==a.c?a.v+"%":e.W+"px",f.style.height="s"==a.g?a.height+"px":"sp"==
