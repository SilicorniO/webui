...
UIPrepare.prototype.addNodes = function $UIPrepare$$addNodes$($nodesAdded$$, $screens$$, $configuration$$) {
  for (var $countNodesAdded$$ = 0; 0 < $nodesAdded$$.length;) {
    ...
    ($node$jscomp$2_parentElement$$ = $node$jscomp$2_parentElement$$.parentNode) && $node$jscomp$2_parentElement$$.ui && ($node$jscomp$2_parentElement$$ = $node$jscomp$2_parentElement$$.ui, $node$jscomp$2_parentElement$$.childrenInOrder = !1, "sc" != $node$jscomp$2_parentElement$$.sizeWidth && "sc" != $node$jscomp$2_parentElement$$.sizeHeight || $node$jscomp$2_parentElement$$.cleanSizeLoaded());
  }
...
UIPrepare.prototype.removeNodes = function $UIPrepare$$removeNodes$($parentNodesRemoved$$) {
  for (var $countNodesRemoved$$ = 0; 0 < $parentNodesRemoved$$.length;) {
    ...
    var $refreshParent$$ = function $$refreshParent$$$($node$jscomp$3_parentNode$jscomp$2_view$$) {
      $node$jscomp$3_parentNode$jscomp$2_view$$ && $node$jscomp$3_parentNode$jscomp$2_view$$.ui ? ($node$jscomp$3_parentNode$jscomp$2_view$$ = $node$jscomp$3_parentNode$jscomp$2_view$$.ui, $node$jscomp$3_parentNode$jscomp$2_view$$.childrenInOrder = !1, "sc" != $node$jscomp$3_parentNode$jscomp$2_view$$.sizeWidth && "sc" != $node$jscomp$3_parentNode$jscomp$2_view$$.sizeHeight || $node$jscomp$3_parentNode$jscomp$2_view$$.cleanSizeLoaded()) : ($node$jscomp$3_parentNode$jscomp$2_view$$ = $node$jscomp$3_parentNode$jscomp$2_view$$.parentNode) && 
      $refreshParent$$($node$jscomp$3_parentNode$jscomp$2_view$$);
    };
...
UIPrepare.prototype.updateNodes = function $UIPrepare$$updateNodes$($nodesUpdated$$, $screens$$, $configuration$$) {
  for (var $countNodesModified$$ = 0, $nodeIdsUpdated$$ = []; 0 < $nodesUpdated$$.length;) {
    ...
    if (!$view$$ || !$nodeIdsUpdated$$.includes($view$$.id)) {
      if ($countNodesModified$$ += 1, $view$$ ? ($node$jscomp$4_parent$$.id != $view$$.id && ($view$$.id = $node$jscomp$4_parent$$.id), $view$$.cleanUI(), $view$$.readUI($view$$.element, $configuration$$.attribute, $configuration$$.attributes), $view$$.sizeLoaded = !1, $view$$.childrenInOrder = !1) : $view$$ = this.generateUIViews($node$jscomp$4_parent$$, $configuration$$, $screens$$), $view$$.forEachChild(function($child$$) {
        ...
        $node$jscomp$4_parent$$.childrenInOrder = !1, $node$jscomp$4_parent$$.cleanSizeLoaded();
      }
    }
  }
