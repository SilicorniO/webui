...
UICore.prototype.applySizeContentHor = function $UICore$$applySizeContentHor$($view$$) {
  $view$$.rightChanged ? 0 < $view$$.right && ($view$$.left = $view$$.right - $view$$.widthValue, $view$$.leftChanged = !0) : $view$$.leftChanged && ($view$$.right = $view$$.left + $view$$.widthValue, $view$$.rightChanged = !0, $view$$.leftChanged = !0);
};
UICore.prototype.applySizeContentVer = function $UICore$$applySizeContentVer$($view$$) {
  if ($view$$.bottomChanged) {
    0 < $view$$.bottom && ($view$$.top = $view$$.bottom - $view$$.heightValue, $view$$.topChanged = !0);
  } else {
    if ($view$$.topChanged) {
...
UICore.prototype.applySizeChildrenHor = function $UICore$$applySizeChildrenHor$($view$$, $arrayViews$$, $indexes$$, $viewsRestored$$) {
  var $$jscomp$this$$ = this, $maxX$$ = 0;
  $view$$.forEachChild(function($child$$, $index$$) {
    $child$$.right > $maxX$$ && 0 < $child$$.width && ($maxX$$ = $child$$.right);
  });
  ...
  $view$$.forEachChild(function($child$$) {
    if (!$child$$.leftChanged || !$child$$.rightChanged || 0 >= $child$$.width) {
      $child$$.cleanHor(), $$jscomp$this$$.calculateViewHor($child$$, $view$$, $arrayViews$$, $indexes$$, $maxX$$, $viewsRestored$$);
    }
  });
};
UICore.prototype.applySizeChildrenVer = function $UICore$$applySizeChildrenVer$($view$$, $arrayViews$$, $indexes$$, $viewsRestored$$) {
  var $$jscomp$this$$ = this, $maxY$$ = 0;
  $view$$.forEachChild(function($child$$) {
    $child$$.bottom > $maxY$$ && 0 < $child$$.height && ($maxY$$ = $child$$.bottom);
  });
  ...
  $view$$.forEachChild(function($child$$) {
    if (!$child$$.topChanged || !$child$$.bottomChanged || 0 >= $child$$.height) {
      $child$$.cleanVer(), $$jscomp$this$$.calculateViewVer($child$$, $view$$, $arrayViews$$, $indexes$$, $maxY$$, $viewsRestored$$);
    }
  });
};
  ...
  if (null == $viewDependency$$) {
    ...
    switch($iReference$$) {
      ...
      case 1:
        ...
        break;
      case 2:
        $view$$.right = $parentView$$ == $viewDependency$$ ? $parentView$$.rightChanged ? $width$$ : 0 : $viewDependency$$.rightChanged ? $viewDependency$$.right : $viewDependency$$.left + $viewDependency$$.width;
        $view$$.rightChanged = !0;
        break;
      case 3:
  ...
  if (null == $viewDependency$$) {
    ...
    switch($iReference$$) {
      ...
      case 1:
        ...
        break;
      case 2:
        $view$$.bottom = $parentView$$ == $viewDependency$$ ? $parentView$$.bottomChanged ? $height$$ : 0 : $viewDependency$$.bottomChanged ? $viewDependency$$.bottom : $viewDependency$$.top + $viewDependency$$.height;
        $view$$.bottomChanged = !0;
        break;
      case 3:
