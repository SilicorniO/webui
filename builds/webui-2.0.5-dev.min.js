...
UIViewUtils.prototype.calculateWidthView = function $UIViewUtils$$calculateWidthView$($view$jscomp$6_width$$, $ele$$, $index$$, $infiniteParent$$) {
  $ele$$.style.position = "fixed";
  $ele$$.style.width = "auto";
  $view$jscomp$6_width$$ = $ele$$.offsetWidth;
  0 < $view$jscomp$6_width$$ && $view$jscomp$6_width$$++;
  return $view$jscomp$6_width$$;
};
...
;function UIConfiguration($uiConf$$) {
  ...
  this.logsView = null;
  this.animations = {defaultTime:0.3, defaultOpacity:!0};
  if ($uiConf$$) {
...
UIView.prototype.init = function $UIView$$init$($lastViewId$$, $attributeMain$$, $attributes$$) {
...
UIView.prototype.readUI = function $UIView$$readUI$($element$jscomp$8_gValues_referencesHor_referencesVer_value$$, $i$jscomp$15_parent$$, $aValues$jscomp$1_lastViewId$$, $attributeMain$$, $attr_attributes$$) {
  $aValues$jscomp$1_lastViewId$$ = UIUtilsInstance.readAttributes($element$jscomp$8_gValues_referencesHor_referencesVer_value$$.getAttribute($attributeMain$$));
  for ($i$jscomp$15_parent$$ = 0; $i$jscomp$15_parent$$ < $attr_attributes$$.length; $i$jscomp$15_parent$$++) {
    $aValues$jscomp$1_lastViewId$$ = $aValues$jscomp$1_lastViewId$$.concat(UIUtilsInstance.readAttributes($element$jscomp$8_gValues_referencesHor_referencesVer_value$$.getAttribute($attr_attributes$$[$i$jscomp$15_parent$$])));
  }
  if (0 != $aValues$jscomp$1_lastViewId$$.length) {
    for ($i$jscomp$15_parent$$ = 0; $i$jscomp$15_parent$$ < $aValues$jscomp$1_lastViewId$$.length; $i$jscomp$15_parent$$++) {
      $attr_attributes$$ = $aValues$jscomp$1_lastViewId$$[$i$jscomp$15_parent$$].attr, $element$jscomp$8_gValues_referencesHor_referencesVer_value$$ = $aValues$jscomp$1_lastViewId$$[$i$jscomp$15_parent$$].value, "w" == $attr_attributes$$ ? this.setWidth($element$jscomp$8_gValues_referencesHor_referencesVer_value$$) : "fw" == $attr_attributes$$ ? this.setWidth("100%") : "h" == $attr_attributes$$ ? this.setHeight($element$jscomp$8_gValues_referencesHor_referencesVer_value$$) : "fh" == $attr_attributes$$ ? 
      this.setHeight("100%") : "l" == $attr_attributes$$ ? this.setLeft($element$jscomp$8_gValues_referencesHor_referencesVer_value$$) : "r" == $attr_attributes$$ ? this.setRight($element$jscomp$8_gValues_referencesHor_referencesVer_value$$) : "t" == $attr_attributes$$ ? this.setTop($element$jscomp$8_gValues_referencesHor_referencesVer_value$$) : "b" == $attr_attributes$$ ? this.setBottom($element$jscomp$8_gValues_referencesHor_referencesVer_value$$) : "al" == $attr_attributes$$ ? this.setAtLeft($element$jscomp$8_gValues_referencesHor_referencesVer_value$$) : 
      ...
      !1 : !0 : "sv" == $attr_attributes$$ ? this.setScrollVertical(!0) : "sh" == $attr_attributes$$ ? this.setScrollHorizontal(!0) : "v" == $attr_attributes$$ && this.setVisibility($element$jscomp$8_gValues_referencesHor_referencesVer_value$$);
    }
    $aValues$jscomp$1_lastViewId$$ = !1;
    $element$jscomp$8_gValues_referencesHor_referencesVer_value$$ = this.getReferencesHor();
    for ($i$jscomp$15_parent$$ = 0; $i$jscomp$15_parent$$ < $element$jscomp$8_gValues_referencesHor_referencesVer_value$$.length; $i$jscomp$15_parent$$++) {
      if (0 < $element$jscomp$8_gValues_referencesHor_referencesVer_value$$[$i$jscomp$15_parent$$].length) {
        $aValues$jscomp$1_lastViewId$$ = !0;
        break;
      }
    }
    $aValues$jscomp$1_lastViewId$$ || this.setLeft("p");
    $aValues$jscomp$1_lastViewId$$ = !1;
    ...
    $aValues$jscomp$1_lastViewId$$ || this.setTop("p");
  }
};
...
UIPrepare.prototype.generateUIView = function $UIPrepare$$generateUIView$($element$$, $parent$jscomp$8_view$$, $screen$$, $config$$, $lastViewId$$) {
  return $element$$.ui ? $element$$.ui : null != $element$$.tagName && null != $element$$.getAttribute($config$$.attribute) ? (0 == $element$$.id.length && ($element$$.id = "_aID_" + this.generatedId, this.generatedId++), $parent$jscomp$8_view$$ = new UIView($element$$, $parent$jscomp$8_view$$, $screen$$, $lastViewId$$, $config$$.attribute, $config$$.attributes), $element$$.style.opacity = "0", null != $element$$.tagName && "img" == $element$$.tagName.toLowerCase() && ($element$$.onload = function() {
    $element$$.sizeLoaded = !1;
    this.refreshFunc();
  }.bind(this)), $parent$jscomp$8_view$$) : null;
};
UIPrepare.prototype.generateUIViews = function $UIPrepare$$generateUIViews$($element$$, $config$$, $aScreens$$, $parentElement_view$$, $i$jscomp$17_lastViewId$$) {
  $aScreens$$ || ($aScreens$$ = []);
  var $lastChildId_parent$$ = null, $childView_screen$$ = null;
  if (null == $parentElement_view$$) {
    $parentElement_view$$ = $element$$.parentNode;
    var $previousElement$$ = $element$$.previousSibling;
    null != $previousElement$$ && $previousElement$$.id && ($i$jscomp$17_lastViewId$$ = $previousElement$$.id);
  }
  null != $parentElement_view$$ && $parentElement_view$$.ui && ($lastChildId_parent$$ = $element$$.parentNode.ui, $childView_screen$$ = $lastChildId_parent$$.screen ? $lastChildId_parent$$.screen : $lastChildId_parent$$);
  ($parentElement_view$$ = this.generateUIView($element$$, $lastChildId_parent$$, $childView_screen$$, $config$$, $i$jscomp$17_lastViewId$$)) && !$lastChildId_parent$$ && ($aScreens$$.push($parentElement_view$$), $element$$.style.position = "relative");
  $lastChildId_parent$$ = $parentElement_view$$ ? $parentElement_view$$.id : "";
  for ($i$jscomp$17_lastViewId$$ = 0; $i$jscomp$17_lastViewId$$ < $element$$.childNodes.length; $i$jscomp$17_lastViewId$$++) {
    if ($childView_screen$$ = this.generateUIViews($element$$.childNodes[$i$jscomp$17_lastViewId$$], $config$$, $aScreens$$, $element$$, $lastChildId_parent$$)) {
      $lastChildId_parent$$ = $childView_screen$$.id;
    }
  }
...
UIDraw.prototype.applyPositions = function $UIDraw$$applyPositions$($parentView$$, $viewColors$$) {
  ...
  $parentView$$.forEachChild(function($childrenSize_view$$) {
    ...
    $ele$$.style.position = "absolute";
    console.log("Position to absolute: " + $childrenSize_view$$.id);
    ...
    $viewColors$$ && ($ele$$.style.backgroundColor = this.generateRandomViewColor());
...
UIDraw.prototype.applyVisibility = function $UIDraw$$applyVisibility$($view$$, $parentView$$, $configuration$$, $forceGone$$) {
  ...
  "g" == $view$$.visibility || (void 0 === $forceGone$$ ? 0 : $forceGone$$) ? ($ele$$.style.display = "none", $ele$$.style.opacity = "0") : ($ele$$.style.display = "inline-block", $ele$$.style.opacity = "i" == $view$$.visibility || $parentView$$ && "i" == $parentView$$.visibility ? "0" : "1");
  $configuration$$.animations.defaultOpacity && ($ele$$.style.transition = "opacity " + $configuration$$.animations.defaultTime + "s ease 0s");
...
UICore.prototype.calculateViewsHor = function $UICore$$calculateViewsHor$($views$$, $parentView$$, $arrayViews$$, $indexes$$, $height$$, $viewsRestored$$) {
  for (var $i$$ = 0; $i$$ < $views$$.length; $i$$++) {
    $views$$[$i$$].hasToBeCalculated() && this.calculateViewHor($views$$[$i$$], $parentView$$, $arrayViews$$, $indexes$$, $height$$, $viewsRestored$$);
  }
};
UICore.prototype.calculateViewHor = function $UICore$$calculateViewHor$($view$$, $parentView$$, $arrayViews$$, $indexes$$, $width$$, $viewsRestored$$) {
  for (var $references$$ = $view$$.getReferencesHor(), $n$$ = 0; $n$$ < $references$$.length; $n$$++) {
    var $dependency$$ = this.calculateViewDependency($view$$, $references$$[$n$$], $parentView$$);
    0 < $dependency$$.length && this.evalDependenceHor($view$$, $parentView$$, $width$$, $n$$, $arrayViews$$[$indexes$$[$dependency$$]]);
  }
  ...
  $view$$.leftChanged && $view$$.rightChanged ? (this.assignSizeHor($view$$, $width$$), this.assignGravityHor($view$$, $width$$), 0 < $view$$.childrenOrderHor.length && ($parentView$$ = $view$$.scrollHorizontal ? 0 : $view$$.width - $view$$.paddingLeft - $view$$.paddingRight, this.calculateViewsHor($view$$.childrenOrderHor, $view$$, $arrayViews$$, $indexes$$, $parentView$$, $viewsRestored$$), this.applyPaddingChildrenHor($view$$))) : (0 < $view$$.childrenOrderHor.length ? ($parentView$$ = $view$$.scrollHorizontal ? 
  0 : $width$$, this.calculateViewsHor($view$$.childrenOrderHor, $view$$, $arrayViews$$, $indexes$$, $parentView$$, $viewsRestored$$), this.applyPaddingChildrenHor($view$$), this.applySizeChildrenHor($view$$)) : this.applySizeContentHor($view$$), this.assignSizeHor($view$$, $width$$), this.assignGravityHor($view$$, $width$$));
...
UICore.prototype.calculateViewVer = function $UICore$$calculateViewVer$($view$$, $parentView$$, $arrayViews$$, $indexes$$, $height$$, $viewsRestored$$) {
  for (var $references$$ = $view$$.getReferencesVer(), $n$$ = 0; $n$$ < $references$$.length; $n$$++) {
    var $dependency$$ = this.calculateViewDependency($view$$, $references$$[$n$$], $parentView$$);
    0 < $dependency$$.length && this.evalDependenceVer($view$$, $parentView$$, $height$$, $n$$, $arrayViews$$[$indexes$$[$dependency$$]]);
  }
  ...
  $view$$.topChanged && $view$$.bottomChanged ? (this.assignSizeVer($view$$, $height$$), this.assignGravityVer($view$$, $height$$), 0 < $view$$.childrenOrderVer.length && ($parentView$$ = $view$$.scrollVertical ? 0 : $view$$.height - $view$$.paddingTop - $view$$.paddingBottom, this.calculateViewsVer($view$$.childrenOrderVer, $view$$, $arrayViews$$, $indexes$$, $parentView$$, $viewsRestored$$), this.applyPaddingChildrenVer($view$$))) : (0 < $view$$.childrenOrderVer.length ? ($parentView$$ = $view$$.scrollVertical ? 
  0 : $height$$, this.calculateViewsVer($view$$.childrenOrderVer, $view$$, $arrayViews$$, $indexes$$, $parentView$$, $viewsRestored$$), this.applyPaddingChildrenVer($view$$), this.applySizeChildrenVer($view$$)) : this.applySizeContentVer($view$$), this.assignSizeVer($view$$, $height$$), this.assignGravityVer($view$$, $height$$));
...
UICore.prototype.applySizeContentHor = function $UICore$$applySizeContentHor$($view$$) {
  $view$$.rightChanged ? ($view$$.left = $view$$.right - $view$$.widthValue, $view$$.leftChanged = !0) : 0 <= $view$$.right && ($view$$.right = $view$$.left + $view$$.widthValue, $view$$.rightChanged = !0, $view$$.leftChanged = !0);
};
...
UICore.prototype.applySizeChildrenHor = function $UICore$$applySizeChildrenHor$($view$$) {
  var $maxX$$ = 0;
  $view$$.forEachChild(function($child$$, $index$$) {
    $child$$.right > $maxX$$ && ($maxX$$ = $child$$.right);
  });
  $view$$.rightChanged ? $view$$.left = $view$$.right - $maxX$$ - $view$$.paddingLeft : ($view$$.right = $view$$.left + $maxX$$ + $view$$.paddingRight, $view$$.rightChanged = !0);
  $view$$.leftChanged = !0;
  $view$$.forEachChild(function($child$$, $index$$) {
    0 > $child$$.width && ($child$$.right = $maxX$$, $child$$.width = $child$$.right - $child$$.left);
  });
};
UICore.prototype.applySizeChildrenVer = function $UICore$$applySizeChildrenVer$($view$$) {
  var $maxY$$ = 0;
  $view$$.forEachChild(function($child$$, $index$$) {
    $child$$.bottom > $maxY$$ && ($maxY$$ = $child$$.bottom);
  });
  $view$$.bottomChanged ? ($view$$.top = $view$$.bottom - $maxY$$ - $view$$.paddingTop, $view$$.topChanged = !0) : ($view$$.bottom = $view$$.top + $maxY$$ + $view$$.paddingBottom, $view$$.bottomChanged = !0);
  $view$$.forEachChild(function($child$$, $index$$) {
    0 > $child$$.height && ($child$$.bottom = $maxY$$, $child$$.height = $child$$.bottom - $child$$.top);
  });
};
...
UICore.prototype.assignGravityHor = function $UICore$$assignGravityHor$($view$$, $width$$) {
  "n" != $view$$.gravityHor && ("l" == $view$$.gravityHor ? ($view$$.left = 0, $view$$.leftChanged = !0) : "r" == $view$$.gravityHor ? ($view$$.right = $width$$, $view$$.left = $view$$.right - $view$$.width) : "c" == $view$$.gravityHor && ($view$$.left = ($width$$ - $view$$.width) / 2, $view$$.right = $view$$.left + $view$$.width, $view$$.leftChanged = !0, $view$$.rightChanged = !0));
};
UICore.prototype.assignGravityVer = function $UICore$$assignGravityVer$($view$$, $height$$) {
  "n" != $view$$.gravityVer && ("t" == $view$$.gravityVer ? ($view$$.top = 0, $view$$.topChanged = !0) : "b" == $view$$.gravityVer ? ($view$$.bottom = $height$$, $view$$.top = $view$$.bottom - $view$$.height) : "c" == $view$$.gravityVer && ($view$$.top = ($height$$ - $view$$.height) / 2, $view$$.bottom = $view$$.top + $view$$.height, $view$$.topChanged = !0, $view$$.bottomChanged = !0));
};
  ...
  this.redraw = function() {
    this.redrawTimer.timer(function() {
      for (; 0 < this.nodesAdded.length;) {
        var $node$jscomp$2_parent$jscomp$10_parentElement$jscomp$1_parentNode$jscomp$1_parentView$$ = this.nodesAdded[0];
        this.nodesAdded.splice(0, 1);
        this.uiPrepare.generateUIViews($node$jscomp$2_parent$jscomp$10_parentElement$jscomp$1_parentNode$jscomp$1_parentView$$, this.configuration, this.screens);
        ($node$jscomp$2_parent$jscomp$10_parentElement$jscomp$1_parentNode$jscomp$1_parentView$$ = $node$jscomp$2_parent$jscomp$10_parentElement$jscomp$1_parentNode$jscomp$1_parentView$$.parentNode) && $node$jscomp$2_parent$jscomp$10_parentElement$jscomp$1_parentNode$jscomp$1_parentView$$.ui && ($node$jscomp$2_parent$jscomp$10_parentElement$jscomp$1_parentNode$jscomp$1_parentView$$ = $node$jscomp$2_parent$jscomp$10_parentElement$jscomp$1_parentNode$jscomp$1_parentView$$.ui, $node$jscomp$2_parent$jscomp$10_parentElement$jscomp$1_parentNode$jscomp$1_parentView$$.childrenInOrder = 
        !1, "sc" == $node$jscomp$2_parent$jscomp$10_parentElement$jscomp$1_parentNode$jscomp$1_parentView$$.sizeWidth || "sc" == $node$jscomp$2_parent$jscomp$10_parentElement$jscomp$1_parentNode$jscomp$1_parentView$$.sizeHeight) && ($node$jscomp$2_parent$jscomp$10_parentElement$jscomp$1_parentNode$jscomp$1_parentView$$.sizeLoaded = !1);
      }
      for (; 0 < this.parentNodesRemoved.length;) {
        $node$jscomp$2_parent$jscomp$10_parentElement$jscomp$1_parentNode$jscomp$1_parentView$$ = this.parentNodesRemoved[0];
        this.parentNodesRemoved.splice(0, 1);
        var $refreshParent$$ = function $$refreshParent$$$($node$jscomp$3_parentNode$jscomp$2_view$$) {
          if ($node$jscomp$3_parentNode$jscomp$2_view$$ && $node$jscomp$3_parentNode$jscomp$2_view$$.ui) {
            if ($node$jscomp$3_parentNode$jscomp$2_view$$ = $node$jscomp$3_parentNode$jscomp$2_view$$.ui, $node$jscomp$3_parentNode$jscomp$2_view$$.childrenInOrder = !1, "sc" == $node$jscomp$3_parentNode$jscomp$2_view$$.sizeWidth || "sc" == $node$jscomp$3_parentNode$jscomp$2_view$$.sizeHeight) {
              $node$jscomp$3_parentNode$jscomp$2_view$$.sizeLoaded = !1;
            }
          } else {
            ($node$jscomp$3_parentNode$jscomp$2_view$$ = $node$jscomp$3_parentNode$jscomp$2_view$$.parentNode) && $refreshParent$$($node$jscomp$3_parentNode$jscomp$2_view$$);
          }
        };
        $refreshParent$$($node$jscomp$2_parent$jscomp$10_parentElement$jscomp$1_parentNode$jscomp$1_parentView$$);
      }
      for (; 0 < this.nodesUpdated.length;) {
        if ($node$jscomp$2_parent$jscomp$10_parentElement$jscomp$1_parentNode$jscomp$1_parentView$$ = this.nodesUpdated[0], this.nodesUpdated.splice(0, 1), delete $node$jscomp$2_parent$jscomp$10_parentElement$jscomp$1_parentNode$jscomp$1_parentView$$.ui, view = this.uiPrepare.generateUIViews($node$jscomp$2_parent$jscomp$10_parentElement$jscomp$1_parentNode$jscomp$1_parentView$$, this.configuration, this.screens)) {
          if ($node$jscomp$2_parent$jscomp$10_parentElement$jscomp$1_parentNode$jscomp$1_parentView$$ = view.parent) {
            $node$jscomp$2_parent$jscomp$10_parentElement$jscomp$1_parentNode$jscomp$1_parentView$$.childrenInOrder = !1, $node$jscomp$2_parent$jscomp$10_parentElement$jscomp$1_parentNode$jscomp$1_parentView$$.sizeLoaded = !1;
          }
        }
      }
      this.drawScreens();
    ...
    for (var $$jscomp$key$mutation_mutation$$ = $$jscomp$iter$0_mutationsList$$.next(); !$$jscomp$key$mutation_mutation$$.done; $$jscomp$key$mutation_mutation$$ = $$jscomp$iter$0_mutationsList$$.next()) {
      if ($$jscomp$key$mutation_mutation$$ = $$jscomp$key$mutation_mutation$$.value, "childList" == $$jscomp$key$mutation_mutation$$.type) {
        ...
        if ("attributes" == $$jscomp$key$mutation_mutation$$.type) {
          "data-ui" == $$jscomp$key$mutation_mutation$$.attributeName && (console.log($$jscomp$key$mutation_mutation$$), console.log(this.configuration.attribute), console.log(this.configuration.attributes));
          $attributeName$jscomp$1_i$$ = $$jscomp$key$mutation_mutation$$.attributeName;
          if ("id" == $attributeName$jscomp$1_i$$ || $attributeName$jscomp$1_i$$ == this.configuration.attribute || this.configuration.attributes.includes($attributeName$jscomp$1_i$$)) {
            this.nodesUpdated.push($$jscomp$key$mutation_mutation$$.target), this.redraw();
          }
          "style" == $attributeName$jscomp$1_i$$ && "relative" == $$jscomp$key$mutation_mutation$$.target.style.position && console.log("mutation style relative: " + $$jscomp$key$mutation_mutation$$.target.id);
        }
      }
    }
  }.bind(this);
...
WebUI.prototype.drawScreens = function $WebUI$$drawScreens$() {
  ...
  if (0 == this.screens.length) {
    ...
    this.uiPrepare.generateUIViews($bodyElement$jscomp$1_i$$, this.configuration, this.screens);
  }
...
WebUI.prototype.drawUIScreen = function $WebUI$$drawUIScreen$($screen$$) {
  ...
  var $childrenSizes_screenSizeChanged$$ = this.uiPrepare.loadSizeScreen($screen$$);
  $screen$$.hasToBeCalculated() && (this.uiPrepare.loadSizes($screen$$.getChildElements(), this.configuration, $childrenSizes_screenSizeChanged$$), endCounterLog("loadSizes"), startCounter("orderViews"), this.uiPrepare.orderViews($screen$$), endCounterLog("orderViews"), endCounterLog("prepare"), startCounter("core"), this.uiCore.calculateScreen($screen$$), endCounterLog("core"));
  startCounter("draw");
  $childrenSizes_screenSizeChanged$$ = this.uiDraw.applyPositions($screen$$, this.configuration.viewColors, !$screen$$.hasToBeCalculated());
  this.uiDraw.applyVisibility($screen$$, null, this.configuration, !$screen$$.hasToBeCalculated());
  this.uiDraw.applySizeScreen($screen$$, $childrenSizes_screenSizeChanged$$.maxX, $childrenSizes_screenSizeChanged$$.maxY);
  endCounterLog("draw");
