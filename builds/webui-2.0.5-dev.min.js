...
UIView.prototype.readUI = function $UIView$$readUI$($element$jscomp$8_gValues_referencesHor_referencesVer_value$$, $i$jscomp$15_parent$$, $aValues$jscomp$1_attributeMain$$, $attr_attributes$$) {
  $aValues$jscomp$1_attributeMain$$ = UIUtilsInstance.readAttributes($element$jscomp$8_gValues_referencesHor_referencesVer_value$$.getAttribute($aValues$jscomp$1_attributeMain$$));
  for ($i$jscomp$15_parent$$ = 0; $i$jscomp$15_parent$$ < $attr_attributes$$.length; $i$jscomp$15_parent$$++) {
    $aValues$jscomp$1_attributeMain$$ = $aValues$jscomp$1_attributeMain$$.concat(UIUtilsInstance.readAttributes($element$jscomp$8_gValues_referencesHor_referencesVer_value$$.getAttribute($attr_attributes$$[$i$jscomp$15_parent$$])));
  }
  if (0 != $aValues$jscomp$1_attributeMain$$.length) {
    for ($i$jscomp$15_parent$$ = 0; $i$jscomp$15_parent$$ < $aValues$jscomp$1_attributeMain$$.length; $i$jscomp$15_parent$$++) {
      $attr_attributes$$ = $aValues$jscomp$1_attributeMain$$[$i$jscomp$15_parent$$].attr, $element$jscomp$8_gValues_referencesHor_referencesVer_value$$ = $aValues$jscomp$1_attributeMain$$[$i$jscomp$15_parent$$].value, "w" == $attr_attributes$$ ? this.setWidth($element$jscomp$8_gValues_referencesHor_referencesVer_value$$) : "fw" == $attr_attributes$$ ? this.setWidth("100%") : "h" == $attr_attributes$$ ? this.setHeight($element$jscomp$8_gValues_referencesHor_referencesVer_value$$) : "fh" == $attr_attributes$$ ? 
    ...
    $aValues$jscomp$1_attributeMain$$ = !1;
    ...
    for ($i$jscomp$15_parent$$ = 0; $i$jscomp$15_parent$$ < $element$jscomp$8_gValues_referencesHor_referencesVer_value$$.length; $i$jscomp$15_parent$$++) {
      if (0 < $element$jscomp$8_gValues_referencesHor_referencesVer_value$$[$i$jscomp$15_parent$$].length) {
        $aValues$jscomp$1_attributeMain$$ = !0;
        break;
      }
    }
    $aValues$jscomp$1_attributeMain$$ || this.setLeft("p");
    $aValues$jscomp$1_attributeMain$$ = !1;
    ...
    $aValues$jscomp$1_attributeMain$$ || this.setTop("p");
  }
};
...
UIPrepare.prototype.generateUIView = function $UIPrepare$$generateUIView$($element$$, $parent$jscomp$8_view$$, $screen$$, $config$$) {
  return $element$$.ui ? $element$$.ui : null != $element$$.tagName && null != $element$$.getAttribute($config$$.attribute) ? (0 == $element$$.id.length && ($element$$.id = "_aID_" + this.generatedId, this.generatedId++), $parent$jscomp$8_view$$ = new UIView($element$$, $parent$jscomp$8_view$$, $screen$$, $config$$.attribute, $config$$.attributes), $element$$.style.opacity = "0", null != $element$$.tagName && "img" == $element$$.tagName.toLowerCase() && ($element$$.onload = function() {
    $element$$.sizeLoaded = !1;
    this.refreshFunc();
  }.bind(this)), $parent$jscomp$8_view$$) : null;
};
UIPrepare.prototype.generateUIViews = function $UIPrepare$$generateUIViews$($element$$, $config$$, $aScreens$$, $parentElement_view$$) {
  $aScreens$$ || ($aScreens$$ = []);
  var $lastChildId_parent$$ = null, $i$jscomp$17_screen$$ = null;
  if (null == $parentElement_view$$) {
    $parentElement_view$$ = $element$$.parentNode;
    var $childView_previousElement$$ = $element$$.previousSibling;
    null != $childView_previousElement$$ && $childView_previousElement$$.id && (lastViewId = $childView_previousElement$$.id);
  }
  null != $parentElement_view$$ && $parentElement_view$$.ui && ($lastChildId_parent$$ = $element$$.parentNode.ui, $i$jscomp$17_screen$$ = $lastChildId_parent$$.screen ? $lastChildId_parent$$.screen : $lastChildId_parent$$);
  ($parentElement_view$$ = this.generateUIView($element$$, $lastChildId_parent$$, $i$jscomp$17_screen$$, $config$$)) && !$lastChildId_parent$$ && ($aScreens$$.push($parentElement_view$$), $element$$.style.position = "relative");
  $lastChildId_parent$$ = $parentElement_view$$ ? $parentElement_view$$.id : "";
  for ($i$jscomp$17_screen$$ = 0; $i$jscomp$17_screen$$ < $element$$.childNodes.length; $i$jscomp$17_screen$$++) {
    if ($childView_previousElement$$ = this.generateUIViews($element$$.childNodes[$i$jscomp$17_screen$$], $config$$, $aScreens$$, $element$$, $lastChildId_parent$$)) {
      $lastChildId_parent$$ = $childView_previousElement$$.id;
    }
  }
...
UIPrepare.prototype.addNodes = function $UIPrepare$$addNodes$($nodesAdded$$, $screens$$, $configuration$$) {
  for (var $countNodesAdded$$ = 0; 0 < $nodesAdded$$.length;) {
    $countNodesAdded$$ += 1;
    var $node$jscomp$2_parentElement$$ = $nodesAdded$$[0];
    $nodesAdded$$.splice(0, 1);
    this.generateUIViews($node$jscomp$2_parentElement$$, $configuration$$, $screens$$);
    ($node$jscomp$2_parentElement$$ = $node$jscomp$2_parentElement$$.parentNode) && $node$jscomp$2_parentElement$$.ui && ($node$jscomp$2_parentElement$$ = $node$jscomp$2_parentElement$$.ui, $node$jscomp$2_parentElement$$.childrenInOrder = !1, "sc" == $node$jscomp$2_parentElement$$.sizeWidth || "sc" == $node$jscomp$2_parentElement$$.sizeHeight) && ($node$jscomp$2_parentElement$$.sizeLoaded = !1);
  }
...
UIPrepare.prototype.updateNodes = function $UIPrepare$$updateNodes$($nodesUpdated$$, $screens$$, $configuration$$) {
  for (var $countNodesModified$$ = 0, $nodeIdsUpdated$$ = []; 0 < $nodesUpdated$$.length;) {
    var $node$jscomp$4_parent$$ = $nodesUpdated$$[0];
    $nodesUpdated$$.splice(0, 1);
    var $view$$ = $node$jscomp$4_parent$$.ui;
    if (!$view$$ || !$nodeIdsUpdated$$.includes($view$$.id)) {
      if ($countNodesModified$$ += 1, $view$$ ? ($node$jscomp$4_parent$$.id != $view$$.id && ($view$$.id = $node$jscomp$4_parent$$.id), $view$$.clean(), $view$$.readUI($view$$.element, $view$$.parent, "", $configuration$$.attribute, $configuration$$.attributeNames), $view$$.sizeLoaded = !1, $view$$.childrenInOrder = !1) : $view$$ = this.generateUIViews($node$jscomp$4_parent$$, $configuration$$, $screens$$), $view$$.forEachChild(function($child$$) {
        if (null == $child$$.parent) {
          var $screenIndex$$ = $screens$$.indexOf($child$$);
          -1 < $screenIndex$$ && $screens$$.splice($screenIndex$$, 1);
        }
        $child$$.parent = $view$$;
      }), $view$$ && ($nodeIdsUpdated$$.push($view$$.id), $node$jscomp$4_parent$$ = $view$$.parent)) {
        $node$jscomp$4_parent$$.childrenInOrder = !1, $node$jscomp$4_parent$$.sizeLoaded = !1;
      }
    }
  }
...
WebUI.prototype.drawUIScreen = function $WebUI$$drawUIScreen$($screen$$) {
  var $timerLoadSizes$$ = 0, $timerOrderViews$$ = 0, $timerPrepare$$ = 0, $timerCore$$ = 0;
  startCounter("all");
  startCounter("prepare");
  startCounter("loadSizes");
  this.configuration.sendStartEvent();
  var $childrenSizes_screenSizeChanged_timerDraw$$ = this.uiPrepare.loadSizeScreen($screen$$);
  $screen$$.hasToBeCalculated() && (this.uiPrepare.loadSizes($screen$$.getChildElements(), this.configuration, $childrenSizes_screenSizeChanged_timerDraw$$), $timerLoadSizes$$ = endCounter("loadSizes"), startCounter("orderViews"), this.uiPrepare.orderViews($screen$$), $timerOrderViews$$ = endCounter("orderViews"), $timerPrepare$$ = endCounter("prepare"), startCounter("core"), this.uiCore.calculateScreen($screen$$), $timerCore$$ = endCounter("core"));
  startCounter("draw");
  $childrenSizes_screenSizeChanged_timerDraw$$ = this.uiDraw.applyPositions($screen$$, this.configuration.viewColors, !$screen$$.hasToBeCalculated());
  this.uiDraw.applyVisibility($screen$$, null, this.configuration, !$screen$$.hasToBeCalculated());
  this.uiDraw.applySizeScreen($screen$$, $childrenSizes_screenSizeChanged_timerDraw$$.maxX, $childrenSizes_screenSizeChanged_timerDraw$$.maxY);
  $childrenSizes_screenSizeChanged_timerDraw$$ = endCounter("draw");
  this.configuration.sendEndEvent();
  var $timerAll$$ = endCounter("all");
  log("[" + $screen$$.id + "] All: " + $timerAll$$ + "ms - Prepare: " + $timerPrepare$$ + "ms - Core: " + $timerCore$$ + "ms - Draw: " + $childrenSizes_screenSizeChanged_timerDraw$$ + "ms - LoadSizes: " + $timerLoadSizes$$ + "ms - OrderViews: " + $timerOrderViews$$ + "ms");
};
