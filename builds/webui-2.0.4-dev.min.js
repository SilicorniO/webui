...
UIRedrawTimer.prototype.timerLauncher=function(a,b){setTimeout(function(){var a=(new Date).getTime();a>this.time?(b(),this.time=null):this.timerLauncher(this.time-a,b)}.bind(this),a)};function UIViewUtils(){}UIViewUtils.prototype.calculateWidthView=function(a,b,c,e){a=b.parentElement;a.removeChild(b);e.appendChild(b);b.style.display="inline-block";b.style.width="auto";b.style.height="auto";var d=b.offsetWidth;0<d&&d++;e.removeChild(b);a.insertBefore(b,a.getChildElements()[c]);return d};
UIViewUtils.prototype.calculateHeightView=function(a,b,c,e){a=b.parentElement;a.removeChild(b);e.appendChild(b);b.style.display="inline-block";b.style.width="auto";b.style.height="auto";var d=b.offsetHeight;0<d&&d++;e.removeChild(b);a.insertBefore(b,a.getChildElements()[c]);return d};
...
UIPrepare.prototype.loadSizesSlow=function(a,b,c){c=void 0===c?!1:c;for(var e=0;e<a.length;e++){var d=a[e],f=d.ui;if(f){if(c||!f.sizeLoaded)"sc"!=f.sizeWidth||f.hasUIChildren()||(f.width=UIViewUtilsInstance.calculateWidthViewSlow(f,d)),"sc"!=f.sizeHeight||f.hasUIChildren()||(f.height=UIViewUtilsInstance.calculateHeightViewSlow(f,d)),f.applyDimens(b),f.sizeLoaded=!0;this.loadSizesSlow(f.getChildElements(),b,c||!f.sizeLoaded)}}};
UIPrepare.prototype.loadSizes=function(a,b){var c=document.createElement("div");c.style.display="inline-block";c.style.width=1E5;c.style.height=1E5;c.style.backgroundColor="black";c.style.zIndex=-1;var e=document.getElementById("screen");e.appendChild(c);for(var d=[],f=0;f<a.length;f++)d.push(a[f]);for(;0<d.length;){a=d[0];d.splice(0,1);var h=document.getElementById(a.id);a.sizeLoaded||("sc"==a.sizeWidth&&0==a.children.length&&(a.width=UIViewUtilsInstance.calculateWidthView(a,h,f,c)),"sc"==a.sizeHeight&&
0==a.children.length&&(a.height=UIViewUtilsInstance.calculateHeightView(a,h,f,c)),a.applyDimens(b),a.sizeLoaded=!0);if(0<a.children.length)for(f=0;f<a.children.length;f++)d.push(a.children[f])}e.removeChild(c)};
UIPrepare.prototype.loadSizeScreen=function(a){var b=!1,c=a.element;if("sc"!=a.sizeWidth){"s"==a.sizeWidth?c.style.width=a.width+"px":"sp"==a.sizeWidth&&(c.style.width=a.percentWidth+"%");var e=c.offsetWidth;e!=a.width&&(a.width=e,b=!0)}"sc"!=a.sizeHeight&&("s"==a.sizeHeight?c.style.height=a.height+"px":"sp"==a.sizeWidth&&(c.style.height=a.percentHeight+"%"),a.height=c.offsetHeight);a.right=a.width;a.bottom=a.height;a.rightChanged=!0;a.leftChanged=!0;a.bottomChanged=!0;a.topChanged=!0;a.sizeLoaded=
!0;return b};UIPrepare.prototype.restoreSizes=function(a,b){for(var c=0;c<a.children.length&&c<b.length;c++)a.children[c].width=b[c].width,a.children[c].height=b[c].height,this.restoreSizes(a.children[c],b[c].children)};
...
WebUI.prototype.drawUIScreen=function(a){startCounter("prepare");startCounter("loadSizes");this.configuration.sendStartEvent();var b=this.uiPrepare.loadSizeScreen(a);this.uiPrepare.loadSizesSlow(a.getChildElements(),this.configuration,b);endCounterLog("loadSizes");startCounter("orderViews");this.uiPrepare.orderViews(a);endCounterLog("orderViews");endCounterLog("prepare");startCounter("core");this.uiCore.calculateScreen(a);endCounterLog("core");startCounter("draw");b=this.uiDraw.applyPositions(a,this.configuration.viewColors);
this.uiDraw.applySizeScreen(a,b.maxX,b.maxY);endCounterLog("draw");this.configuration.sendEndEvent();endCounterLog("all")};var WebUIInstance=new WebUI;window.WebUI=WebUIInstance;window.WebUI.start=WebUIInstance.start;window.WebUI.refresh=WebUIInstance.refresh;
