...
$jscomp.polyfill("Array.prototype.keys",function(a){return a?a:function(){return $jscomp.iteratorFromArray(this,function(a){return a})}},"es6","es3");function UIRedrawTimer(){this.time=null}UIRedrawTimer.prototype.timer=function(a,b){b||(b=20);var c=null!=this.time;this.time=(new Date).getTime()+b;c||this.timerLauncher(b,a)};
UIRedrawTimer.prototype.timerLauncher=function(a,b){setTimeout(function(){var a=(new Date).getTime();a>this.time?(this.time=null,b()):this.timerLauncher(this.time-a,b)}.bind(this),a)};function UIViewUtils(){}UIViewUtils.prototype.calculateWidthView=function(a,b,c,e){b.style.position="fixed";b.style.width="auto";a=b.offsetWidth;0<a&&a++;return a};UIViewUtils.prototype.calculateHeightView=function(a,b,c,e){b.style.position="fixed";b.style.height="auto";a=b.offsetHeight;0<a&&a++;return a};
...
f.attribute),f.dimens))for(var g=Object.keys(f.dimens),k=0;k<g.length;k++)b[g[k]]=f.dimens[g[k]]}this.attributes=a;this.selectedDimens=b};UIConfiguration.prototype.getDimen=function(a){if(this.selectedDimens[a])return parseInt(this.selectedDimens[a],10);if(a&&!isNaN(parseInt(a,10)))return parseInt(a,10);logE('The dimension "'+a+'" is not valid or it is not defined');return 0};UIConfiguration.prototype.sendStartEvent=function(){this.events&&this.events({name:"start"})};
UIConfiguration.prototype.sendEndEvent=function(){this.events&&this.events({name:"end",attributes:this.attributes})};function UIView(a,b,c,e,d,f){this.id=a.id;this.element=a;this.parent=b;this.screen=c;this.childrenOrderHor=[];this.childrenOrderVer=[];this.childrenUI=!0;this.orderNum=this.order=0;this.dependenciesHor=[];this.dependenciesVer=[];this.bottomTop=this.bottomBottom=this.topBottom=this.topTop=this.rightLeft=this.rightRight=this.leftRight=this.leftLeft="";this.sizeHeight=this.sizeWidth="sc";this.percentHeightPos=this.percentWidthPos=this.heightValue=this.widthValue=0;this.scrollHorizontal=this.scrollVertical=
!1;this.gravityVer=this.gravityHor="n";this.paddingBottomDimen=this.paddingRightDimen=this.paddingTopDimen=this.paddingLeftDimen=this.marginBottomDimen=this.marginRightDimen=this.marginTopDimen=this.marginLeftDimen="0";this.visibility="v";this.animationDurations=[];this.bottom=this.right=this.top=this.left=this.height=this.width=0;this.scrollHorizontalApplied=this.scrollVerticalApplied=this.bottomChanged=this.rightChanged=this.topChanged=this.leftChanged=!1;this.paddingBottom=this.paddingRight=this.paddingTop=
this.paddingLeft=this.marginBottom=this.marginRight=this.marginTop=this.marginLeft=0;this.childrenInOrder=this.sizeLoaded=!1;this.init(e,d,f);this.setWidth=this.setWidth;this.setHeight=this.setHeight;this.setLeft=this.setLeft;this.setRight=this.setRight;this.setTop=this.setTop;this.setBottom=this.setBottom;this.setAtLeft=this.setAtLeft;this.setAtRight=this.setAtRight;this.setAtTop=this.setAtTop;this.setAtBottom=this.setAtBottom;this.setMarginLeft=this.setMarginLeft;this.setMarginRight=this.setMarginRight;
this.setMarginTop=this.setMarginTop;this.setMarginBottom=this.setMarginBottom;this.setMargins=this.setMargins;this.setPaddingLeft=this.setPaddingLeft;this.setPaddingRight=this.setPaddingRight;this.setPaddingTop=this.setPaddingTop;this.setPaddingBottom=this.setPaddingBottom;this.setPaddings=this.setPaddings;this.setVisibility=this.setVisibility;this.animateNextRefresh=this.animateNextRefresh}
UIView.prototype.init=function(a,b,c){this.readUI(this.element,this.parent,a?a:"",b,c);this.element.ui=this;this.element.ui=this};UIView.prototype.setWidth=function(a){if("sc"==a)this.sizeWidth=a,this.widthValue=0;else if(-1!=String(a).indexOf("%")){var b=a.indexOf("%");this.widthValue=parseFloat(a.substring(0,b));b<a.length-1&&(this.percentWidthPos=parseInt(a.substring(b+1,a.length),10));this.sizeWidth="sp"}else this.widthValue=parseInt(a,10),this.sizeWidth="s";this.sizeLoaded=!1};
UIView.prototype.setHeight=function(a){if("sc"==a)this.sizeHeight=a,this.heightValue=0;else if(-1!=String(a).indexOf("%")){var b=a.indexOf("%");this.heightValue=parseInt(a.substring(0,b),10);b<a.length-1&&(this.percentHeightPos=parseInt(a.substring(b+1,a.length),10));this.sizeHeight="sp"}else this.heightValue=parseInt(a,10),this.sizeHeight="s";this.sizeLoaded=!1};UIView.prototype.setLeft=function(a){this.leftLeft=a;this.sizeLoaded=!1};
UIView.prototype.setRight=function(a){this.rightRight=a;this.sizeLoaded=!1};UIView.prototype.setTop=function(a){this.topTop=a;this.sizeLoaded=!1};UIView.prototype.setBottom=function(a){this.bottomBottom=a;this.sizeLoaded=!1};UIView.prototype.setAtLeft=function(a){this.rightLeft=a;this.sizeLoaded=!1};UIView.prototype.setAtRight=function(a){this.leftRight=a;this.sizeLoaded=!1};UIView.prototype.setAtTop=function(a){this.bottomTop=a;this.sizeLoaded=!1};
UIView.prototype.setAtBottom=function(a){this.topBottom=a;this.sizeLoaded=!1};UIView.prototype.setScrollVertical=function(a){this.scrollVertical=a};UIView.prototype.setScrollHorizontal=function(a){this.scrollHorizontal=a};UIView.prototype.setGravityHorizontal=function(a){this.gravityHor=a};UIView.prototype.setGravityVertical=function(a){this.gravityVer=a};UIView.prototype.setGravity=function(a,b){this.gravityHor=a;this.gravityVer=b};
UIView.prototype.setMarginLeft=function(a){this.marginLeftDimen=a;this.sizeLoaded=!1};UIView.prototype.setMarginTop=function(a){this.marginTopDimen=a;this.sizeLoaded=!1};UIView.prototype.setMarginRight=function(a){this.marginRightDimen=a;this.sizeLoaded=!1};UIView.prototype.setMarginBottom=function(a){this.marginBottomDimen=a;this.sizeLoaded=!1};
UIView.prototype.setMargins=function(a,b,c,e){this.marginLeftDimen=a;this.marginTopDimen=b;this.marginRightDimen=c;this.marginBottomDimen=e;this.sizeLoaded=!1};UIView.prototype.setPaddingLeft=function(a){this.paddingLeftDimen=a;this.sizeLoaded=!1};UIView.prototype.setPaddingTop=function(a){this.paddingTopDimen=a;this.sizeLoaded=!1};UIView.prototype.setPaddingRight=function(a){this.paddingRightDimen=a;this.sizeLoaded=!1};
UIView.prototype.setPaddingBottom=function(a){this.paddingBottomDimen=a;this.sizeLoaded=!1};UIView.prototype.setPaddings=function(a,b,c,e){this.paddingLeftDimen=a;this.paddingTopDimen=b;this.paddingRightDimen=c;this.paddingBottomDimen=e;this.sizeLoaded=!1};UIView.prototype.setVisibility=function(a){"g"!=a&&"g"==this.visibility&&(this.sizeLoaded=!1);this.visibility=a};
UIView.prototype.updateVisibilityWithCss=function(){"none"==this.element.style.display?this.setVisibility("g"):"hidden"==this.element.style.visibility?this.setVisibility("i"):this.setVisibility("v")};UIView.prototype.hasToBeCalculated=function(){return"g"!=this.visibility};UIView.prototype.animateNextRefresh=function(a){this.animationDurations.push(a)};
UIView.prototype.getReferences=function(){return[this.leftLeft,this.leftRight,this.rightRight,this.rightLeft,this.topTop,this.topBottom,this.bottomBottom,this.bottomTop]};UIView.prototype.getReferencesHor=function(){return[this.leftLeft,this.leftRight,this.rightRight,this.rightLeft]};UIView.prototype.getReferencesVer=function(){return[this.topTop,this.topBottom,this.bottomBottom,this.bottomTop]};
UIView.prototype.setReference=function(a,b){switch(a){case 0:this.leftLeft=b;break;case 1:this.leftRight=b;break;case 2:this.rightRight=b;break;case 3:this.rightLeft=b;break;case 4:this.topTop=b;break;case 5:this.topBottom=b;break;case 6:this.bottomBottom=b;break;case 7:this.bottomTop=b}};UIView.prototype.hasUIChildren=function(){for(var a=this.element.childNodes,b=0;b<a.length;b++)if(a[b].ui)return!0;return!1};UIView.prototype.getChildElements=function(){return this.element.childNodes};
UIView.prototype.forEachChild=function(a){for(var b=this.element.childNodes,c=0;c<b.length;c++){var e=b[c].ui;e&&a(e,c)}};UIView.prototype.getPreviousView=function(){for(var a=null,b=this.parent.element.childNodes,c=0;c<b.length;c++){var e=b[c].ui;if(e){if(e.id==this.id)return a;e.hasToBeCalculated()&&(a=e)}}return null};UIView.prototype.clean=function(){this.bottomChanged=this.rightChanged=this.topChanged=this.leftChanged=!1;this.height=this.width=this.bottom=this.right=this.top=this.left=0};
...
UIPrepare.prototype.orderViewsSameParent=function(a,b){var c=a.getChildElements(),e=[],d=0,f=null;a.forEachChild(function(c,g){g=0;for(var h=b?c.getReferencesHor():c.getReferencesVer(),k=0;k<h.length;k++){var m=h[k];"p"==m?m=a.id:"l"==m&&(m=f?f.id:"");0<m.length&&(b?c.dependenciesHor.push(m):c.dependenciesVer.push(m),g++)}0==g?(c.orderNum=0,d++):c.orderNum=-1;e.push(c);f=c});var g=UIViewUtilsInstance.generateIndexes(c);do{var k=!0;var n=0;a.forEachChild(function(a,d){if(-1==a.orderNum){d=b?a.dependenciesHor:
a.dependenciesVer;for(var e=0,f=0;f<d.length;f++){var h=0;null!=g[d[f]]&&(h=c[g[d[f]]].ui.orderNum);if(-1<h)e+=h+1;else{e=0;break}}0<e?(a.orderNum=e,n++):k=!1}})}while(!k&&0<n);0==n&&a.hasUIChildren()&&d<c.length&&logE("Check cycle references in "+(b?"horizontal":"vertical")+" for parent "+a.id);e.sort(function(a,b){return a.orderNum-b.orderNum});return e};
UIPrepare.prototype.loadSizes=function(a,b,c){c=void 0===c?!1:c;for(var e=0;e<a.length;e++){var d=a[e],f=d.ui;f&&f.hasToBeCalculated()&&("none"==d.style.display&&(d.style.display="inline-block"),!f.hasToBeCalculated()||!c&&f.sizeLoaded||("sc"!=f.sizeWidth||f.hasUIChildren()||(f.widthValue=UIViewUtilsInstance.calculateWidthView(f,d)),"sc"!=f.sizeHeight||f.hasUIChildren()||(f.heightValue=UIViewUtilsInstance.calculateHeightView(f,d)),f.applyDimens(b),f.sizeLoaded=!0),this.loadSizes(f.getChildElements(),
b,c||!f.sizeLoaded))}};
UIPrepare.prototype.loadSizeScreen=function(a){var b=!1,c=a.element;c.style.position="absolute";if("sc"!=a.sizeWidth){"s"==a.sizeWidth?c.style.width=a.widthValue+"px":"sp"==a.sizeWidth&&(c.style.width=a.widthValue+"%");var e=c.offsetWidth;e!=a.width&&(a.width=e,b=!0)}"sc"!=a.sizeHeight&&("s"==a.sizeHeight?c.style.height=a.heightValue+"px":"sp"==a.sizeWidth&&(c.style.height=a.heightValue+"%"),a.height=c.offsetHeight);c.style.position="relative";a.right=a.width;a.bottom=a.height;a.rightChanged=!0;a.leftChanged=
!0;a.bottomChanged=!0;a.topChanged=!0;a.sizeLoaded=!0;return b};UIPrepare.prototype.generateUIView=function(a,b,c,e,d){return a.ui?a.ui:null!=a.tagName&&null!=a.getAttribute(e.attribute)?(0==a.id.length&&(a.id="_aID_"+this.generatedId,this.generatedId++),b=new UIView(a,b,c,d,e.attribute,e.attributes),null!=a.tagName&&"img"==a.tagName.toLowerCase()&&(a.onload=function(){a.sizeLoaded=!1;this.refreshFunc()}.bind(this)),b):null};
UIPrepare.prototype.generateUIViews=function(a,b,c,e,d){c||(c=[]);var f=null,g=null;if(null==e){e=a.parentNode;var k=a.previousSibling;null!=k&&k.id&&(d=k.id)}null!=e&&e.ui&&(f=a.parentNode.ui,g=f.screen?f.screen:f);(e=this.generateUIView(a,f,g,b,d))&&!f&&(c.push(e),a.style.position="relative");f=e?e.id:"";for(d=0;d<a.childNodes.length;d++)if(g=this.generateUIViews(a.childNodes[d],b,c,a,f))f=g.id;return e};function UIDraw(){}
UIDraw.prototype.applyPositions=function(a,b,c){c=void 0===c?!1:c;var e=0,d=0,f=0,g=0,k=0,n=0;a.forEachChild(function(h,m){var l=h.element;n=k=g=f=0;0==l.childElementCount&&(m=window.getComputedStyle(l),"sc"==h.sizeWidth&&(f=parseInt(m.paddingLeft,10),g=parseInt(m.paddingRight,10)),"sc"==h.sizeHeight&&(k=parseInt(m.paddingTop,10),n=parseInt(m.paddingBottom,10)));l.style.display="inline-block";l.style.margin="auto";0<l.childElementCount&&(l.style.padding="0px");"g"==h.visibility||c?l.style.display=
"none":(l.style.display="inline-block",l.style.visibility="i"==h.visibility||"i"==a.visibility?"hidden":"visible");m=parseInt(h.left,10);var t=parseInt(h.top,10),p=0<h.width?h.width-f-g:0,q=0<h.height?h.height-k-n:0;l.style.left=m+"px";l.style.top=t+"px";0<p&&(l.style.width=p+"px");0<q&&(l.style.height=q+"px");l.style.position="absolute";if(0<h.animationDurations.length){l.style.transition="all "+h.animationDurations[0]+"s ease 0s";l.ui.animationDurations.splice(0,1);var r=function(a){log(a);l.style.transition=
"";l.removeEventListener("transitionend",r)};l.addEventListener("transitionend",r)}h.left+h.width>e&&(e=h.left+h.width);h.top+h.height>d&&(d=h.top+h.height);b&&(l.style.backgroundColor=this.generateRandomViewColor());h=this.applyPositions(h,b,"none"==l.style.display);h.maxX>e&&(e=h.maxX);h.maxY>d&&(d=h.maxY)}.bind(this));return{maxX:e,maxY:d}};
UIDraw.prototype.generateRandomViewColor=function(){var a=parseInt(255*Math.random(),10),b=parseInt(255*Math.random(),10),c=parseInt(255*Math.random(),10);return"rgba("+a+","+b+","+c+",0.4)"};UIDraw.prototype.applySizeScreen=function(a,b,c){var e=document.getElementById(a.id);"s"!=a.id&&null!=e&&(e.style.width="s"==a.sizeWidth?a.width+"px":"sp"==a.sizeWidth?a.widthValue+"%":b+"px",e.style.height="s"==a.sizeHeight?a.height+"px":"sp"==a.sizeHeight?a.heightValue+"%":c+"px")};function UICore(a){this.scrollWidth=a}UICore.prototype.calculateScreen=function(a){var b=UIViewUtilsInstance.generateArrayViews(a),c=UIViewUtilsInstance.generateIndexes(b);do{var e=[];for(var d=1;d<b.length;d++)b[d].clean();this.calculateViewsHor(a.childrenOrderHor,a,b,c,a.width,e);this.calculateViewsVer(a.childrenOrderVer,a,b,c,a.height,e)}while(0<e.length)};
UICore.prototype.calculateViewsHor=function(a,b,c,e,d,f){for(var g=0;g<a.length;g++)a[g].hasToBeCalculated()&&this.calculateViewHor(a[g],b,c,e,d,f)};
UICore.prototype.calculateViewHor=function(a,b,c,e,d,f){for(var g=a.getReferencesHor(),k=0;k<g.length;k++){var n=this.calculateViewDependency(a,g[k],b);0<n.length&&this.evalDependenceHor(a,b,d,k,c[e[n]])}"s"==a.sizeWidth?this.applyFixedSizeHor(a):"sp"==a.sizeWidth&&this.applyPercentHor(a,b,d);this.assignMarginsHor(a);a.leftChanged&&a.rightChanged?(this.assignSizeHor(a,d),this.assignGravityHor(a,d),0<a.childrenOrderHor.length&&(b=a.scrollHorizontal?0:a.width-a.paddingLeft-a.paddingRight,this.calculateViewsHor(a.childrenOrderHor,
...
UICore.prototype.calculateViewsVer=function(a,b,c,e,d,f){for(var g=0;g<a.length;g++)a[g].hasToBeCalculated()&&this.calculateViewVer(a[g],b,c,e,d,f)};
UICore.prototype.calculateViewVer=function(a,b,c,e,d,f){for(var g=a.getReferencesVer(),k=0;k<g.length;k++){var n=this.calculateViewDependency(a,g[k],b);0<n.length&&this.evalDependenceVer(a,b,d,k,c[e[n]])}"s"==a.sizeHeight?this.applyFixedSizeVer(a):"sp"==a.sizeHeight&&this.applyPercentVer(a,b,d);this.assignMarginsVer(a);a.topChanged&&a.bottomChanged?(this.assignSizeVer(a,d),this.assignGravityVer(a,d),0<a.childrenOrderVer.length&&(b=a.scrollVertical?0:a.height-a.paddingTop-a.paddingBottom,this.calculateViewsVer(a.childrenOrderVer,
...
UICore.prototype.assignSizeVer=function(a,b){a.bottom>b&&0<b&&(a.bottom=b);a.height=a.bottom-a.top};UICore.prototype.applyFixedSizeHor=function(a){a.rightChanged?(a.left=a.right-a.widthValue,a.leftChanged=!0):(a.right=a.left+a.widthValue,a.leftChanged=!0,a.rightChanged=!0)};UICore.prototype.applyFixedSizeVer=function(a){a.bottomChanged?(a.top=a.bottom-a.heightValue,a.topChanged=!0):(a.bottom=a.top+a.heightValue,a.topChanged=!0,a.bottomChanged=!0)};
...
UICore.prototype.applyScrollVer=function(a,b){if(a.scrollVertical){var c=0;a.forEachChild(function(a,b){a.bottom>c&&(c=a.bottom)});if(("sc"!=a.sizeHeight||c>b+a.paddingTop)&&!a.scrollVerticalApplied)return document.getElementById(a.id).style.overflowY="auto",!0}return!1};UICore.prototype.applySizeContentHor=function(a){a.rightChanged?(a.left=a.right-a.widthValue,a.leftChanged=!0):0<=a.right&&(a.right=a.left+a.widthValue,a.rightChanged=!0,a.leftChanged=!0)};
UICore.prototype.applySizeContentVer=function(a){if(a.bottomChanged)a.top=a.bottom-a.heightValue,a.topChanged=!0;else if(0<=a.bottom){var b=document.getElementById(a.id);b.style.width=a.width+"px";a.heightValue=b.offsetHeight;a.bottom=a.top+a.heightValue;a.bottomChanged=!0;a.topChanged=!0}};
...
UICore.prototype.applyPercentHor=function(a,b,c){a.rightChanged&&!a.leftChanged?a.left=a.right-b.width*a.widthValue/100:a.right=a.left+b.width*a.widthValue/100;0<a.percentWidthPos&&(b=(a.right-a.left)*a.percentWidthPos,a.left+=b,a.right+=b);a.rightChanged=!0;a.leftChanged=!0};
UICore.prototype.applyPercentVer=function(a,b,c){a.bottomChanged&&!a.topChanged?a.top=a.bottom-b.height*a.heightValue/100:a.bottom=a.top+b.height*a.heightValue/100;0<a.percentHeightPos&&(b=(a.bottom-a.top)*a.percentHeightPos,a.top+=b,a.bottom+=b);a.bottomChanged=!0;a.topChanged=!0};
...
function WebUI(){this.scrollHeight=this.scrollWidth=0;this.screens=[];this.nodesAdded=[];this.parentNodesRemoved=[];this.uiPrepare=new UIPrepare(this.refresh.bind(this));this.uiDraw=new UIDraw;this.configuration=this.uiCore=null;this.redrawTimer=new UIRedrawTimer;this.redraw=function(){this.redrawTimer.timer(function(){for(;0<this.nodesAdded.length;){var a=this.nodesAdded[0];this.nodesAdded.splice(0,1);this.uiPrepare.generateUIViews(a,this.configuration,this.screens);(a=a.parentNode)&&a.ui&&(a=a.ui,
a.childrenInOrder=!1,"sc"==a.sizeWidth||"sc"==a.sizeHeight)&&(a.sizeLoaded=!1)}for(;0<this.parentNodesRemoved.length;){a=this.parentNodesRemoved[0];this.parentNodesRemoved.splice(0,1);var b=function(a){if(a&&a.ui){if(a=a.ui,a.childrenInOrder=!1,"sc"==a.sizeWidth||"sc"==a.sizeHeight)a.sizeLoaded=!1}else(a=a.parentNode)&&b(a)};b(a)}this.drawScreens()}.bind(this),this.configuration.timeRedraw)}.bind(this);this.resize=function(){this.configuration.refreshScreenSize();this.redraw()}.bind(this)}
...
WebUI.prototype.listenDomEvents=function(){var a=this;document.getElementsByTagName("BODY")[0].addEventListener("DOMNodeInserted",function(b){a.nodesAdded.push(b.srcElement);a.redraw()},!1);document.getElementsByTagName("BODY")[0].addEventListener("DOMNodeRemoved",function(b){a.parentNodesRemoved.push(b.relatedNode);a.redraw()},!1);window.removeEventListener("resize",this.resize);window.addEventListener("resize",this.resize)};
...
this.configuration.viewColors,!a.hasToBeCalculated());this.uiDraw.applySizeScreen(a,b.maxX,b.maxY);endCounterLog("draw");this.configuration.sendEndEvent();endCounterLog("all")};var WebUIInstance=new WebUI;window.WebUI=WebUIInstance;window.WebUI.start=WebUIInstance.start;window.WebUI.refresh=WebUIInstance.refresh;
