...
function ba(a,b,c){var e=[];null==b?(b=document.getElementsByTagName("BODY")[0],b.style.overflow="hidden",a="s"):a=b.id;b=b.childNodes;for(var d=a,f=0;f<b.length;f++){var h=b[f],k=!1;if(null!=h.tagName&&null!=h.getAttribute(c.K)&&"none"!=h.style.display){0==h.id.length&&(h.id="_aID_"+O,O++);var g=D(h,a,d,c.K,c.attributes);e.push(g);d=g.id;g.N&&(g.children=ba(a,h,c),k=!0)}P||ca(h,!k)}return e}
