...
a.b=!0):"sp"==a.c&&(a.b&&a.f||(a.right=d),a.right=a.left+(a.right-a.left)*a.C/100,b=(a.right-a.left)*a.O,a.left+=b,a.right+=b,a.b=!0,a.f=!0);b=a.marginLeft;h=a.marginRight;0!=b&&a.f&&(a.left+=b,a.b&&"s"!=a.c||(a.right+=b));0!=h&&a.b&&(a.right-=h,a.f&&"s"!=a.c||(a.left-=h));if(a.f&&a.b){if(r(a,d),t(a,d),0<a.i.length){b=a.I?0:a.width-a.paddingLeft-a.paddingRight;for(h=0;h<a.i.length;h++)p(a.i[h],a,c,e,b,f);u(a)}}else{if(0<a.i.length){b=a.I?0:d;for(h=0;h<a.i.length;h++)p(a.i[h],a,c,e,b,f);u(a);for(e=
c=0;e<a.children.length;e++)b=a.children[e],b.right>c&&(c=b.right);a.b?a.left=a.right-c-a.paddingLeft:(a.right=a.left+c+a.paddingRight,a.b=!0);a.f=!0;for(e=0;e<a.children.length;e++)b=a.children[e],0>b.width&&(b.right=c,b.width=b.right-b.left)}else a.b?(a.left=a.right-a.width,a.f=!0):0<=a.right&&(a.right=a.left+a.width,a.b=!0,a.f=!0);r(a,d);t(a,d)}a:{if(a.I){for(e=c=0;e<a.children.length;e++)b=a.children[e],b.right>c&&(c=b.right);if(c>d+a.paddingLeft&&!a.R){document.getElementById(a.id).style.overflowX=
...
a},ga:function(a){this.v=a},da:function(a){this.G=a},za:function(a){this.J=a},ya:function(a){this.I=a},na:function(a){this.o=a},oa:function(a){this.s=a},ma:function(a,c){this.o=a;this.s=c},ra:function(a){this.marginLeft=a},ta:function(a){this.marginTop=a},sa:function(a){this.marginRight=a},qa:function(a){this.marginBottom=a},ha:function(a,c,e,d){this.marginLeft=a;this.marginTop=c;this.marginRight=e;this.marginBottom=d},va:function(a){this.paddingLeft=a},xa:function(a){this.paddingTop=a},wa:function(a){this.paddingRight=
a},ua:function(a){this.paddingBottom=a},ia:function(a,c,e,d){this.paddingLeft=a;this.paddingTop=c;this.paddingRight=e;this.paddingBottom=d},la:function(){return[this.w,this.A,this.F,this.D,this.H,this.G,this.u,this.v]},aa:function(){return[this.w,this.A,this.F,this.D]},ba:function(){return[this.H,this.G,this.u,this.v]},Ea:function(a,c){switch(a){case 0:this.w=c;break;case 1:this.A=c;break;case 2:this.F=c;break;case 3:this.D=c;break;case 4:this.H=c;break;case 5:this.G=c;break;case 6:this.u=c;break;
...
a.l(this.paddingTop);this.paddingBottom=a.l(this.paddingBottom);this.marginLeft=a.l(this.marginLeft);this.marginRight=a.l(this.marginRight);this.marginTop=a.l(this.marginTop)},clone:function(){var b=E(a);b.L=this.L;for(var c=0;c<this.children.length;c++)b.children.push(this.children[c].clone());for(c=0;c<this.i.length;c++)for(var e=0;e<b.children.length;e++)if(b.children[e].id==this.i[c].id){b.i.push(b.children[e]);break}for(c=0;c<this.j.length;c++)for(e=0;e<b.children.length;e++)if(b.children[e].id==
this.j[c].id){b.j.push(b.children[e]);break}b.N=this.N;b.ca=this.ca;b.m=this.m;for(c=0;c<this.K.length;c++)b.K.push(this.K[c]);b.w=this.w;b.A=this.A;b.F=this.F;b.D=this.D;b.H=this.H;b.G=this.G;b.u=this.u;b.v=this.v;b.c=this.c;b.g=this.g;b.left=this.left;b.top=this.top;b.right=this.right;b.bottom=this.bottom;b.f=this.f;b.h=this.h;b.b=this.b;b.a=this.a;b.width=this.width;b.height=this.height;b.J=this.J;b.I=this.I;b.S=this.S;b.R=this.R;b.C=this.C;b.B=this.B;b.O=this.O;b.P=this.P;b.o=this.o;b.s=this.s;
...
", pl:"+this.paddingLeft+", pr:"+this.paddingRight+", pt:"+this.paddingTop+", pb:"+this.paddingBottom+", w:"+this.width+", h:"+this.height+", sh:"+this.c+", sh:"+this.g+", pId:"+this.L+", l:"+this.left+", r:"+this.right+", t:"+this.top+", b:"+this.bottom}}}
function D(a,b,c,e,d){var f=E(a.id);f.L=b;var h;h=F(a.getAttribute(e));for(e=0;e<d.length;e++)h=h.concat(F(a.getAttribute(d[e])));if(0==h.length)return f;for(e=0;e<h.length;e++)d=h[e].U,a=h[e].value,"p"==a?a=b:"l"==a&&(a=c),"w"==d?f.Aa(a):"h"==d?f.pa(a):"l"==d?f.Z(a):"r"==d?f.$(a):"t"==d?f.T(a):"b"==d?f.Y(a):"al"==d?f.ea(a):"ale"==d?(f.ea(a),f.T(a),f.Y(a)):"ar"==d?f.fa(a):"are"==d?(f.fa(a),f.T(a),f.Y(a)):"at"==d?f.ga(a):"ate"==d?(f.ga(a),f.Z(a),f.$(a)):"ab"==d?f.da(a):"abe"==d?(f.da(a),f.Z(a),f.$(a)):
"ml"==d?f.ra(a):"mr"==d?f.sa(a):"mt"==d?f.ta(a):"mb"==d?f.qa(a):"m"==d?(d=a.split(","),1==d.length?f.ha(a,a,a,a):4==d.length&&f.ha(d[0],d[1],d[2],d[3])):"pl"==d?f.va(a):"pr"==d?f.wa(a):"pt"==d?f.xa(a):"pb"==d?f.ua(a):"p"==d?(d=a.split(","),1==d.length?f.ia(a,a,a,a):4==d.length&&f.ia(d[0],d[1],d[2],d[3])):"gh"==d?f.na(a):"gv"==d?f.oa(a):"g"==d?(a=a.split(","),2==a.length&&f.ma(a[0],a[1])):"cui"==d?f.N="n"==a?!1:!0:"sv"==d?f.za(!0):"sh"==d&&f.ya(!0);c=!1;h=f.la();for(e=0;e<h.length;e++)if(0<h[e].length){c=
!0;break}c||f.T(b);return f}function F(a){if(null==a)return[];a=a.replace(" ","").split(";");for(var b=[],c=0;c<a.length;c++){var e=a[c].split(":");2==e.length?b.push({U:e[0],value:e[1]}):1==e.length&&b.push({U:e[0],value:""})}return b};var G=!1,H=null;function q(a,b){if(G){var c=b;switch(a){case 1:c="WARNING: "+c;break;case 2:c="ERROR: "+c;break;case 3:c="INFO: "+c}console.log(c);H&&(H.innerHTML+=c+"<BR />")}};function aa(){var a=I,b={M:"ui",attributes:[],V:{},l:function(a){return"undefined"!==typeof this.V[a]?parseInt(this.V[a]):parseInt(a)}};if(!a)return b;a.attribute&&(b.attribute=a.attribute);var c=[],e={};if(a.dimens)for(var d=Object.keys(a.dimens),f=0;f<d.length;f++)e[d[f]]=a.dimens[d[f]];var h=window.innerWidth,k=window.innerHeight;q(0,"screen-width: "+h);q(0,"screen-height: "+k);if(a.screenModes)for(f=0;f<a.screenModes.length;f++){var g=a.screenModes[f];if((!g.widthStart||0==g.widthStart||g.widthStart<
...
function ba(a,b,c){var e=[];null==b?(b=document.getElementsByTagName("BODY")[0],b.style.overflow="hidden",a="s"):a=b.id;b=b.childNodes;for(var d=a,f=0;f<b.length;f++){var h=b[f],k=!1;if(null!=h.tagName&&null!=h.getAttribute(c.M)&&"none"!=h.style.display){0==h.id.length&&(h.id="_aID_"+O,O++);var g=D(h,a,d,c.M,c.attributes);e.push(g);d=g.id;g.N&&(g.children=ba(a,h,c),k=!0)}P||ca(h,!k)}return e}
...
function ha(a,b,c){M("prepare");U(a.view.children,b);S(a.view);N("prepare");M("core");var e=a.view;n=b;var d=R(e),f=Q(d),h;do{h=[];for(var k=1;k<d.length;k++)d[k].ka();for(k=0;k<e.i.length;k++)p(e.i[k],e,d,f,e.width,h);for(k=0;k<e.j.length;k++)w(e.j[k],e,d,f,e.height,h)}while(0<h.length);N("core");M("draw");e=J(a.view.children);a=a.view;d=e.X;f=document.getElementById(a.id);"s"!=a.id&&null!=f&&(f.style.width="s"==a.c?a.width+"px":"sp"==a.c?a.C+"%":e.W+"px",f.style.height="s"==a.g?a.height+"px":"sp"==
a.g?a.B+"%":d+"px");N("draw");c&&c({name:"end",suffixs:b.Fa});N("all")};
