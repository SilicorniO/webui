var n;
function p(a,b,c,e,d,f){for(var h=a.aa(),k=0;k<h.length;k++){var g=h[k];if(0<g.length){var l=a,m=b,y=d,z=k,g=c[e[g]];if(null==g)q(2,"The view '"+l.id+"' has a wrong reference");else switch(z){case 0:m!=g&&(l.left=g.left);l.f=!0;break;case 1:l.left=g.b?g.right:g.left+g.width;l.f=!0;break;case 2:if(m==g)if(m.b)l.right=y;else{l.right=-1;break}else l.right=g.b?g.right:g.left+g.width;l.b=!0;break;case 3:l.right=g.left,l.b=!0}}}"s"==a.c?a.b?(a.left=a.right-a.width,a.f=!0):(a.right=a.left+a.width,a.f=!0,
...
function E(a){return{id:a,M:"",children:[],i:[],j:[],P:!0,ca:0,m:0,L:[],B:"",C:"",F:"",D:"",H:"",G:"",w:"",A:"",c:"sc",g:"sc",left:0,top:0,right:0,bottom:0,f:!1,h:!1,b:!1,a:!1,width:0,height:0,J:!1,I:!1,S:!1,R:!1,v:0,u:0,N:0,O:0,o:"n",s:"n",marginLeft:"0",marginTop:"0",marginRight:"0",marginBottom:"0",paddingLeft:0,paddingTop:0,paddingRight:0,paddingBottom:0,Da:!1,ka:function(a){if("sc"==a)this.c=a,this.width=0;else if(-1!=String(a).indexOf("%")){var c=a.indexOf("%");this.v=parseFloat(a.substring(0,
c));c<a.length-1&&(this.N=parseInt(a.substring(c+1,a.length)));this.c="sp"}else this.width=parseInt(a),this.c="s"},ha:function(a){if("sc"==a)this.g=a,this.height=0;else if(-1!=String(a).indexOf("%")){var c=a.indexOf("%");this.u=parseInt(a.substring(0,c));c<a.length-1&&(this.O=parseInt(a.substring(c+1,a.length)));this.g="sp"}else this.height=parseInt(a),this.g="s"},Z:function(a){this.B=a},$:function(a){this.F=a},T:function(a){this.H=a},Y:function(a){this.w=a},ea:function(a){this.D=a},fa:function(a){this.C=
a},ga:function(a){this.A=a},da:function(a){this.G=a},Aa:function(a){this.J=a},za:function(a){this.I=a},pa:function(a){this.o=a},qa:function(a){this.s=a},oa:function(a,c){this.o=a;this.s=c},sa:function(a){this.marginLeft=a},ua:function(a){this.marginTop=a},ta:function(a){this.marginRight=a},ra:function(a){this.marginBottom=a},ia:function(a,c,e,d){this.marginLeft=a;this.marginTop=c;this.marginRight=e;this.marginBottom=d},wa:function(a){this.paddingLeft=a},ya:function(a){this.paddingTop=a},xa:function(a){this.paddingRight=
a},va:function(a){this.paddingBottom=a},ja:function(a,c,e,d){this.paddingLeft=a;this.paddingTop=c;this.paddingRight=e;this.paddingBottom=d},na:function(){return[this.B,this.C,this.F,this.D,this.H,this.G,this.w,this.A]},aa:function(){return[this.B,this.C,this.F,this.D]},ba:function(){return[this.H,this.G,this.w,this.A]},Ea:function(a,c){switch(a){case 0:this.B=c;break;case 1:this.C=c;break;case 2:this.F=c;break;case 3:this.D=c;break;case 4:this.H=c;break;case 5:this.G=c;break;case 6:this.w=c;break;
case 7:this.A=c}},Ca:function(a){for(var c=0;c<this.children.length;c++)if(this.children[c].id==a.id){this.children[c]=a;break}for(c=0;c<this.i.length;c++)if(this.i[c].id==a.id){this.i[c]=a;break}for(c=0;c<this.j.length;c++)if(this.j[c].id==a.id){this.j[c]=a;break}},ma:function(){this.a=this.b=this.h=this.f=!1;this.bottom=this.right=this.top=this.left=0;0<this.v&&(this.c="sp");0<this.u&&(this.g="sp")},la:function(a){this.paddingLeft=a.l(this.paddingLeft);this.paddingRight=a.l(this.paddingRight);this.paddingTop=
...
function D(a,b,c,e,d){var f=E(a.id);f.M=b;var h;h=F(a.getAttribute(e));for(e=0;e<d.length;e++)h=h.concat(F(a.getAttribute(d[e])));if(0==h.length)return f;for(e=0;e<h.length;e++)d=h[e].U,a=h[e].value,"p"==a?a=b:"l"==a&&(a=c),"w"==d?f.ka(a):"fw"==d?f.ka("100%"):"h"==d?f.ha(a):"fh"==d?f.ha("100%"):"l"==d?f.Z(a):"r"==d?f.$(a):"t"==d?f.T(a):"b"==d?f.Y(a):"al"==d?f.ea(a):"ale"==d?(f.ea(a),f.T(a),f.Y(a)):"ar"==d?f.fa(a):"are"==d?(f.fa(a),f.T(a),f.Y(a)):"at"==d?f.ga(a):"ate"==d?(f.ga(a),f.Z(a),f.$(a)):"ab"==
d?f.da(a):"abe"==d?(f.da(a),f.Z(a),f.$(a)):"ml"==d?f.sa(a):"mr"==d?f.ta(a):"mt"==d?f.ua(a):"mb"==d?f.ra(a):"m"==d?(d=a.split(","),1==d.length?f.ia(a,a,a,a):4==d.length&&f.ia(d[0],d[1],d[2],d[3])):"pl"==d?f.wa(a):"pr"==d?f.xa(a):"pt"==d?f.ya(a):"pb"==d?f.va(a):"p"==d?(d=a.split(","),1==d.length?f.ja(a,a,a,a):4==d.length&&f.ja(d[0],d[1],d[2],d[3])):"gh"==d?f.pa(a):"gv"==d?f.qa(a):"g"==d?(a=a.split(","),2==a.length&&f.oa(a[0],a[1])):"cui"==d?f.P="n"==a?!1:!0:"sv"==d?f.Aa(!0):"sh"==d&&f.za(!0);c=!1;h=
f.na();for(e=0;e<h.length;e++)if(0<h[e].length){c=!0;break}c||f.T(b);return f}function F(a){if(null==a)return[];a=a.replace(" ","").split(";");for(var b=[],c=0;c<a.length;c++){var e=a[c].split(":");2==e.length?b.push({U:e[0],value:e[1]}):1==e.length&&b.push({U:e[0],value:""})}return b};var G=!1,H=null;function q(a,b){if(G){var c=b;switch(a){case 1:c="WARNING: "+c;break;case 2:c="ERROR: "+c;break;case 3:c="INFO: "+c}console.log(c);H&&(H.innerHTML+=c+"<BR />")}};function aa(){var a=I,b={K:"ui",attributes:[],V:{},l:function(a){return"undefined"!==typeof this.V[a]?parseInt(this.V[a]):parseInt(a)}};if(!a)return b;a.attribute&&(b.K=a.attribute);var c=[],e={};if(a.dimens)for(var d=Object.keys(a.dimens),f=0;f<d.length;f++)e[d[f]]=a.dimens[d[f]];var h=window.innerWidth,k=window.innerHeight;q(0,"screen-width: "+h);q(0,"screen-height: "+k);if(a.screenModes)for(f=0;f<a.screenModes.length;f++){var g=a.screenModes[f];if((!g.widthStart||0==g.widthStart||g.widthStart<
...
"auto",d.style.height="auto",f.height=d.offsetHeight,0<f.height&&f.height++,h.style.height=k,h.scrollTop=g);e.la(b);0<e.children.length&&U(e.children,b)}}
...
function W(a){for(var b=[],c=0;c<a.children.length;c++)b.push({width:a.children[c].width,height:a.children[c].height,children:W(a.children[c])});return b}function ba(a,b){var c=ca(a,a,b);P=!0;return c}
function ca(a,b,c){var e=[];null==b?(b=document.getElementsByTagName("BODY")[0],b.style.overflow="hidden",a="s"):a=b.id;b=b.childNodes;for(var d=a,f=0;f<b.length;f++){var h=b[f],k=!1;if(null!=h.tagName&&null!=h.getAttribute(c.K)&&"none"!=h.style.display){0==h.id.length&&(h.id="_aID_"+O,O++);var g=D(h,a,d,c.K,c.attributes);e.push(g);d=g.id;g.P&&(g.children=ca(a,h,c),k=!0)}P||da(h,!k)}return e}
function da(a,b){null!=a.tagName&&"img"==a.tagName.toLowerCase()&&(a.onload=function(){null==ea?fa():X(ea)});if(b)for(var c=a.childNodes,e=0;e<c.length;e++)da(c[e],!0)}
function ga(a,b,c){null==a&&(a=document.getElementsByTagName("BODY")[0]);null==b&&(b=[]);var e=c.K;a=a.childNodes;for(var d=0;d<a.length;d++){var f=a[d];if(f&&null!=f.tagName){if(null!=f.getAttribute(e)&&"none"!=f.style.display)for(var h=F(f.getAttribute(e)),k=0;k<h.length;k++)if("s"==h[k].U){0==f.id.length&&(f.id="_aID_"+O,O++);b.push(f.id);break}ga(f,b,c)}}return b};var K=!1,I,v=0,ea=null;window.configUI=ha;function ha(a){I=a;a.viewColors&&(K=!0);a.showLogs&&(G=!0,a.Ba&&(H=document.getElementById(a.Ba)))}
function Y(){if(0==v){var a=document.createElement("p");a.style.width="100%";a.style.height="200px";var b=document.createElement("div");b.style.position="absolute";b.style.top="0px";b.style.left="0px";b.style.visibility="hidden";b.style.width="200px";b.style.height="150px";b.style.overflow="hidden";b.appendChild(a);document.body.appendChild(b);var c=a.offsetWidth;b.style.overflow="scroll";a=a.offsetWidth;c==a&&(a=b.clientWidth);document.body.removeChild(b);v=c-a}return aa()}window.drawUI=fa;
function fa(a){M("all");var b=Y(),c=ba(null,b),c=C("s",null,c,b);c.sizes=W(c.view);V(c);ia(c,b,a)}window.drawUIAll=ja;function ja(a){M("all");for(var b=Y(),b=ga(null,null,b),c=0;c<b.length;c++)X(b[c],a)}window.drawUIForId=X;function X(a,b){var c=Y(),e=document.getElementById(a);if(null==e)q(2,"Error getting element with ID: "+a);else{var d=ba(e,c),d=C(a,e,d,c);d.sizes=W(d.view);V(d,e);e.style.position="relative";ia(d,c,b)}}
function ia(a,b,c){M("prepare");U(a.view.children,b);S(a.view);N("prepare");M("core");var e=a.view;n=b;var d=R(e),f=Q(d),h;do{h=[];for(var k=1;k<d.length;k++)d[k].ma();for(k=0;k<e.i.length;k++)p(e.i[k],e,d,f,e.width,h);for(k=0;k<e.j.length;k++)w(e.j[k],e,d,f,e.height,h)}while(0<h.length);N("core");M("draw");e=J(a.view.children);a=a.view;d=e.X;f=document.getElementById(a.id);"s"!=a.id&&null!=f&&(f.style.width="s"==a.c?a.width+"px":"sp"==a.c?a.v+"%":e.W+"px",f.style.height="s"==a.g?a.height+"px":"sp"==
a.g?a.u+"%":d+"px");N("draw");c&&c({name:"end",suffixs:b.Fa});N("all")}window.timerRedraw=ka;var Z=null;function ka(a,b){b||(b=20);Z||la(b,a);Z=(new Date).getTime();Z+=b}function la(a,b){setTimeout(function(){var a=(new Date).getTime();a>Z?(b(),Z=null):la(Z-a,b)},a)};
