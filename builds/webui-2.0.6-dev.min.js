...
UIView.prototype.readUI = function $UIView$$readUI$($element$jscomp$8_referencesHor_referencesVer_value$$, $attributeMain$jscomp$2_i$$, $attr_attributes$$) {
  ...
  for ($attributeMain$jscomp$2_i$$ = 0; $attributeMain$jscomp$2_i$$ < $attr_attributes$$.length; $attributeMain$jscomp$2_i$$++) {
    $aValues$$ = $aValues$$.concat(UIUtilsInstance.readAttributes($element$jscomp$8_referencesHor_referencesVer_value$$.getAttribute($attr_attributes$$[$attributeMain$jscomp$2_i$$])));
  }
  if (0 != $aValues$$.length) {
    for ($attributeMain$jscomp$2_i$$ = 0; $attributeMain$jscomp$2_i$$ < $aValues$$.length; $attributeMain$jscomp$2_i$$++) {
      $attr_attributes$$ = $aValues$$[$attributeMain$jscomp$2_i$$].attr, $element$jscomp$8_referencesHor_referencesVer_value$$ = $aValues$$[$attributeMain$jscomp$2_i$$].value, "w" == $attr_attributes$$ ? this.setWidth($element$jscomp$8_referencesHor_referencesVer_value$$) : "fw" == $attr_attributes$$ ? this.setWidth("100%") : "h" == $attr_attributes$$ ? this.setHeight($element$jscomp$8_referencesHor_referencesVer_value$$) : "fh" == $attr_attributes$$ ? this.setHeight("100%") : "l" == $attr_attributes$$ ? 
      this.setLeft($element$jscomp$8_referencesHor_referencesVer_value$$) : "r" == $attr_attributes$$ ? this.setRight($element$jscomp$8_referencesHor_referencesVer_value$$) : "t" == $attr_attributes$$ ? this.setTop($element$jscomp$8_referencesHor_referencesVer_value$$) : "b" == $attr_attributes$$ ? this.setBottom($element$jscomp$8_referencesHor_referencesVer_value$$) : "al" == $attr_attributes$$ ? this.setAtLeft($element$jscomp$8_referencesHor_referencesVer_value$$) : "ale" == $attr_attributes$$ ? 
      (this.setAtLeft($element$jscomp$8_referencesHor_referencesVer_value$$), this.setTop($element$jscomp$8_referencesHor_referencesVer_value$$), this.setBottom($element$jscomp$8_referencesHor_referencesVer_value$$)) : "ar" == $attr_attributes$$ ? this.setAtRight($element$jscomp$8_referencesHor_referencesVer_value$$) : "are" == $attr_attributes$$ ? (this.setAtRight($element$jscomp$8_referencesHor_referencesVer_value$$), this.setTop($element$jscomp$8_referencesHor_referencesVer_value$$), this.setBottom($element$jscomp$8_referencesHor_referencesVer_value$$)) : 
      "at" == $attr_attributes$$ ? this.setAtTop($element$jscomp$8_referencesHor_referencesVer_value$$) : "ate" == $attr_attributes$$ ? (this.setAtTop($element$jscomp$8_referencesHor_referencesVer_value$$), this.setLeft($element$jscomp$8_referencesHor_referencesVer_value$$), this.setRight($element$jscomp$8_referencesHor_referencesVer_value$$)) : "ab" == $attr_attributes$$ ? this.setAtBottom($element$jscomp$8_referencesHor_referencesVer_value$$) : "abe" == $attr_attributes$$ ? (this.setAtBottom($element$jscomp$8_referencesHor_referencesVer_value$$), 
      this.setLeft($element$jscomp$8_referencesHor_referencesVer_value$$), this.setRight($element$jscomp$8_referencesHor_referencesVer_value$$)) : "ml" == $attr_attributes$$ ? this.setMarginLeft($element$jscomp$8_referencesHor_referencesVer_value$$) : "mr" == $attr_attributes$$ ? this.setMarginRight($element$jscomp$8_referencesHor_referencesVer_value$$) : "mt" == $attr_attributes$$ ? this.setMarginTop($element$jscomp$8_referencesHor_referencesVer_value$$) : "mb" == $attr_attributes$$ ? this.setMarginBottom($element$jscomp$8_referencesHor_referencesVer_value$$) : 
      "m" == $attr_attributes$$ ? ($attr_attributes$$ = $element$jscomp$8_referencesHor_referencesVer_value$$.split(","), 1 == $attr_attributes$$.length ? this.setMargins($element$jscomp$8_referencesHor_referencesVer_value$$, $element$jscomp$8_referencesHor_referencesVer_value$$, $element$jscomp$8_referencesHor_referencesVer_value$$, $element$jscomp$8_referencesHor_referencesVer_value$$) : 4 == $attr_attributes$$.length && this.setMargins($attr_attributes$$[0], $attr_attributes$$[1], $attr_attributes$$[2], 
      $attr_attributes$$[3])) : "pl" == $attr_attributes$$ ? this.setPaddingLeft($element$jscomp$8_referencesHor_referencesVer_value$$) : "pr" == $attr_attributes$$ ? this.setPaddingRight($element$jscomp$8_referencesHor_referencesVer_value$$) : "pt" == $attr_attributes$$ ? this.setPaddingTop($element$jscomp$8_referencesHor_referencesVer_value$$) : "pb" == $attr_attributes$$ ? this.setPaddingBottom($element$jscomp$8_referencesHor_referencesVer_value$$) : "p" == $attr_attributes$$ ? ($attr_attributes$$ = 
      $element$jscomp$8_referencesHor_referencesVer_value$$.split(","), 1 == $attr_attributes$$.length ? this.setPaddings($element$jscomp$8_referencesHor_referencesVer_value$$, $element$jscomp$8_referencesHor_referencesVer_value$$, $element$jscomp$8_referencesHor_referencesVer_value$$, $element$jscomp$8_referencesHor_referencesVer_value$$) : 4 == $attr_attributes$$.length && this.setPaddings($attr_attributes$$[0], $attr_attributes$$[1], $attr_attributes$$[2], $attr_attributes$$[3])) : "cv" == $attr_attributes$$ ? 
      this.setCenterVertical(!0) : "ch" == $attr_attributes$$ ? this.setCenterHorizontal(!0) : "c" == $attr_attributes$$ ? (this.setCenterVertical(!0), this.setCenterHorizontal(!0)) : "cui" == $attr_attributes$$ ? this.childrenUI = "n" == $element$jscomp$8_referencesHor_referencesVer_value$$ ? !1 : !0 : "sv" == $attr_attributes$$ ? this.setScrollVertical(!0) : "sh" == $attr_attributes$$ ? this.setScrollHorizontal(!0) : "v" == $attr_attributes$$ ? this.setVisibility($element$jscomp$8_referencesHor_referencesVer_value$$) : 
    ...
    for ($attributeMain$jscomp$2_i$$ = 0; $attributeMain$jscomp$2_i$$ < $element$jscomp$8_referencesHor_referencesVer_value$$.length; $attributeMain$jscomp$2_i$$++) {
...
UIPrepare.prototype.addNodes = function $UIPrepare$$addNodes$($nodesAdded$$, $screens$$, $configuration$$) {
  for (var $countNodesAdded$$ = 0; 0 < $nodesAdded$$.length;) {
    ...
    var $previousUIView$$ = UIUtilsInstance.getPreviousUIView($node$$), $previousUIScreen$$ = UIUtilsInstance.getPreviousUIScreen($previousUIView$$);
...
UIPrepare.prototype.removeNodes = function $UIPrepare$$removeNodes$($parentNodesRemoved$$) {
  for (var $countNodesRemoved$$ = 0; 0 < $parentNodesRemoved$$.length;) {
    ...
    var $refreshParent$$ = function $$refreshParent$$$($node$jscomp$4_parentNode$jscomp$2_view$$) {
      $node$jscomp$4_parentNode$jscomp$2_view$$ && $node$jscomp$4_parentNode$jscomp$2_view$$.ui ? ($node$jscomp$4_parentNode$jscomp$2_view$$ = $node$jscomp$4_parentNode$jscomp$2_view$$.ui, $node$jscomp$4_parentNode$jscomp$2_view$$.childrenInOrder = !1, "sc" != $node$jscomp$4_parentNode$jscomp$2_view$$.sizeWidth && "sc" != $node$jscomp$4_parentNode$jscomp$2_view$$.sizeHeight || $node$jscomp$4_parentNode$jscomp$2_view$$.cleanSizeLoaded()) : ($node$jscomp$4_parentNode$jscomp$2_view$$ = $node$jscomp$4_parentNode$jscomp$2_view$$.parentNode) && 
...
UIPrepare.prototype.updateNodes = function $UIPrepare$$updateNodes$($nodesUpdated$$, $screens$$, $configuration$$) {
  for (var $countNodesModified$$ = 0, $nodeIdsUpdated$$ = []; 0 < $nodesUpdated$$.length;) {
    ...
    if (!$view$$ || !$nodeIdsUpdated$$.includes($view$$.id)) {
      ...
      if ($view$$) {
        $node$jscomp$5_previousUIScreen$jscomp$1_previousUIView$$.id != $view$$.id && ($view$$.id = $node$jscomp$5_previousUIScreen$jscomp$1_previousUIView$$.id), $view$$.cleanUI(), $view$$.readUI($view$$.element, $configuration$$.attribute, $configuration$$.attributes), $view$$.sizeLoaded = !1, $view$$.childrenInOrder = !1;
      } else {
        ...
        $view$$ = this.generateUIViews($node$jscomp$5_previousUIScreen$jscomp$1_previousUIView$$, $configuration$$, $screens$$, $parent$jscomp$9_parentScreen$$);
      }
      $view$$ && ($view$$.forEachChild(function($child$$) {
        if (null == $child$$.parent) {
          var $screenIndex$$ = $screens$$.indexOf($child$$);
          -1 < $screenIndex$$ && $screens$$.splice($screenIndex$$, 1);
        }
        $child$$.parent = $view$$;
      }), $nodeIdsUpdated$$.push($view$$.id), $parent$jscomp$9_parentScreen$$ = $view$$.parent) && ($parent$jscomp$9_parentScreen$$.childrenInOrder = !1, $parent$jscomp$9_parentScreen$$.cleanSizeLoaded());
      $node$jscomp$5_previousUIScreen$jscomp$1_previousUIView$$ = UIUtilsInstance.getPreviousUIView($node$jscomp$5_previousUIScreen$jscomp$1_previousUIView$$);
      ($node$jscomp$5_previousUIScreen$jscomp$1_previousUIView$$ = UIUtilsInstance.getPreviousUIScreen($node$jscomp$5_previousUIScreen$jscomp$1_previousUIView$$)) && $node$jscomp$5_previousUIScreen$jscomp$1_previousUIView$$.cleanSizeLoaded();
    }
  }
...
UICore.prototype.calculateViewHor = function $UICore$$calculateViewHor$($view$$, $parentView$$, $arrayViews$$, $indexes$$, $width$$, $viewsRestored$$) {
  ...
  $view$$.leftChanged && $view$$.rightChanged ? (this.assignSizeHor($view$$, $width$$), this.assignCenterHor($view$$, $width$$), 0 < $view$$.childrenOrderHor.length && (this.calculateViewsHor($view$$.childrenOrderHor, $view$$, $arrayViews$$, $indexes$$, $view$$.scrollHorizontal ? 0 : $view$$.width - $view$$.paddingLeft - $view$$.paddingRight, $viewsRestored$$), this.applyPaddingChildrenHor($view$$))) : (0 < $view$$.childrenOrderHor.length ? (this.calculateViewsHor($view$$.childrenOrderHor, $view$$, 
  $arrayViews$$, $indexes$$, 0, $viewsRestored$$), this.applyPaddingChildrenHor($view$$), this.applySizeChildrenHor($view$$, $arrayViews$$, $indexes$$, $viewsRestored$$)) : this.applySizeContentHor($view$$), this.assignSizeHor($view$$, $width$$), this.assignCenterHor($view$$, $width$$));
...
UICore.prototype.calculateViewVer = function $UICore$$calculateViewVer$($view$$, $parentView$$, $arrayViews$$, $indexes$$, $height$$, $viewsRestored$$) {
  ...
  $view$$.topChanged && $view$$.bottomChanged ? (this.assignSizeVer($view$$, $height$$), this.assignCenterVer($view$$, $height$$), 0 < $view$$.childrenOrderVer.length && (this.calculateViewsVer($view$$.childrenOrderVer, $view$$, $arrayViews$$, $indexes$$, $view$$.scrollVertical ? 0 : $view$$.height - $view$$.paddingTop - $view$$.paddingBottom, $viewsRestored$$), this.applyPaddingChildrenVer($view$$))) : (0 < $view$$.childrenOrderVer.length ? (this.calculateViewsVer($view$$.childrenOrderVer, $view$$, 
  $arrayViews$$, $indexes$$, 0, $viewsRestored$$), this.applyPaddingChildrenVer($view$$), this.applySizeChildrenVer($view$$, $arrayViews$$, $indexes$$, $viewsRestored$$)) : this.applySizeContentVer($view$$), this.assignSizeVer($view$$, $height$$), this.assignCenterVer($view$$, $height$$));
    ...
    for (var $$jscomp$key$mutation_mutation$$ = $$jscomp$iter$0_mutationsList$$.next(); !$$jscomp$key$mutation_mutation$$.done; $$jscomp$key$mutation_mutation$$ = $$jscomp$iter$0_mutationsList$$.next()) {
      if ($$jscomp$key$mutation_mutation$$ = $$jscomp$key$mutation_mutation$$.value, "childList" == $$jscomp$key$mutation_mutation$$.type) {
        ...
        if ("attributes" == $$jscomp$key$mutation_mutation$$.type) {
          if ($attributeName$jscomp$1_i$$ = $$jscomp$key$mutation_mutation$$.attributeName, "id" == $attributeName$jscomp$1_i$$ || "class" == $attributeName$jscomp$1_i$$ || $attributeName$jscomp$1_i$$ == this.configuration.attribute || this.configuration.attributes.includes($attributeName$jscomp$1_i$$)) {
            this.nodesUpdated.push($$jscomp$key$mutation_mutation$$.target), this.redraw();
          }
        } else {
          "characterData" == $$jscomp$key$mutation_mutation$$.type && ($$jscomp$key$mutation_mutation$$.target.parentNode && this.nodesUpdated.push($$jscomp$key$mutation_mutation$$.target.parentNode), this.redraw());
        }
      }
    }
  }.bind(this);
