...
$jscomp.polyfill = function $$jscomp$polyfill$($property$jscomp$5_split_target$$, $impl_polyfill$$, $fromLang_obj$$, $i$$) {
    if ($impl_polyfill$$) {
        ...
        $impl_polyfill$$ != $i$$ &&
            null != $impl_polyfill$$ &&
            $jscomp.defineProperty($fromLang_obj$$, $property$jscomp$5_split_target$$, { configurable: !0, writable: !0, value: $impl_polyfill$$ })
    }
}
$jscomp.polyfill(
    "Object.is",
...
$jscomp.polyfill(
    ...
    function($orig$$) {
        return $orig$$
            ? $orig$$
            : function($searchElement$$, $i$jscomp$4_opt_fromIndex$$) {
                  var $array$$ = this
...
UIViewUtils.prototype.calculateWidthViewSlow = function $UIViewUtils$$calculateWidthViewSlow$($parent$jscomp$2_view$$, $ele$jscomp$2_width$$) {
    ...
    var $parentWidth$$ = $parent$jscomp$2_view$$.offsetWidth,
        $parentScrollLeft$$ = $parent$jscomp$2_view$$.scrollLeft
...
UIViewUtils.prototype.calculateHeightViewSlow = function $UIViewUtils$$calculateHeightViewSlow$($parent$jscomp$3_view$$, $ele$jscomp$3_height$$) {
    ...
    var $parentHeight$$ = $parent$jscomp$3_view$$.offsetHeight,
        $parentScrollTop$$ = $parent$jscomp$3_view$$.scrollTop
...
UIViewUtils.prototype.getViewsWithDependencyForView = function $UIViewUtils$$getViewsWithDependencyForView$($view$$, $hor$$, $ver$$) {
    ...
    $view$$.parent.forEachChild(function($parentChild$$, $index$$) {
        ;(($hor$$ && $parentChild$$.dependenciesHor.includes($viewId$$)) || ($ver$$ && $parentChild$$.dependenciesVer.includes($viewId$$))) &&
...
UIUtils.prototype.readAttributes = function $UIUtils$$readAttributes$($aValues_text$$) {
    ...
    for (var $aAttributes$$ = [], $i$$ = 0; $i$$ < $aValues_text$$.length; $i$$++) {
        ...
        2 == $aValue$$.length
            ...
            : 1 == $aValue$$.length && $aAttributes$$.push({ attr: $aValue$$[0], value: "" })
    }
    return $aAttributes$$
}
UIUtils.prototype.getPreviousUIScreen = function $UIUtils$$getPreviousUIScreen$($nodeUI$$) {
    return null != $nodeUI$$ && $nodeUI$$.screen ? $nodeUI$$.screen : $nodeUI$$
}
...
UIConfiguration.prototype.refreshScreenSize = function $UIConfiguration$$refreshScreenSize$() {
    ...
    if (this.screenModes) {
        for (var $i$$ = 0; $i$$ < this.screenModes.length; $i$$++) {
            ...
            if (
                (!$screenMode$$.widthStart || 0 == $screenMode$$.widthStart || $screenMode$$.widthStart < $widthScreen$$) &&
                (!$screenMode$$.widthEnd || 0 == $screenMode$$.widthEnd || $screenMode$$.widthEnd > $widthScreen$$) &&
                (!$screenMode$$.heightStart || 0 == $screenMode$$.heightStart || $screenMode$$.heightStart < $heightScreen$$) &&
                (!$screenMode$$.heightEnd || 0 == $screenMode$$.heightEnd || $screenMode$$.heightEnd < $heightScreen$$) &&
                ($aAttributes$$.push($screenMode$$.attribute), log("SHOWING ATTRIBUTE: " + $screenMode$$.attribute), $screenMode$$.dimens)
            ) {
...
function UIView($element$$, $parent$$, $screen$$, $attributeMain$$, $attributes$$) {
    ...
    this.centerVer = this.centerHor = this.scrollHorizontal = this.scrollVertical = !1
...
UIView.prototype.setCenterVertical = function $UIView$$setCenterVertical$($value$$) {
    this.centerVer = $value$$
}
UIView.prototype.setCenterHorizontal = function $UIView$$setCenterHorizontal$($value$$) {
...
UIView.prototype.readUI = function $UIView$$readUI$($element$jscomp$8_referencesHor_referencesVer_value$$, $attributeMain$jscomp$2_i$$, $attr_attributes$$) {
    var $aValues$$ = UIUtilsInstance.readAttributes($element$jscomp$8_referencesHor_referencesVer_value$$.getAttribute($attributeMain$jscomp$2_i$$))
    for ($attributeMain$jscomp$2_i$$ = 0; $attributeMain$jscomp$2_i$$ < $attr_attributes$$.length; $attributeMain$jscomp$2_i$$++) {
        $aValues$$ = $aValues$$.concat(
            UIUtilsInstance.readAttributes($element$jscomp$8_referencesHor_referencesVer_value$$.getAttribute($attr_attributes$$[$attributeMain$jscomp$2_i$$])),
        )
    }
    if (0 != $aValues$$.length) {
        for ($attributeMain$jscomp$2_i$$ = 0; $attributeMain$jscomp$2_i$$ < $aValues$$.length; $attributeMain$jscomp$2_i$$++) {
            ;($attr_attributes$$ = $aValues$$[$attributeMain$jscomp$2_i$$].attr),
                ($element$jscomp$8_referencesHor_referencesVer_value$$ = $aValues$$[$attributeMain$jscomp$2_i$$].value),
                "w" == $attr_attributes$$
                    ? this.setWidth($element$jscomp$8_referencesHor_referencesVer_value$$)
                    : "fw" == $attr_attributes$$
                    ? this.setWidth("100%")
                    : "h" == $attr_attributes$$
                    ? this.setHeight($element$jscomp$8_referencesHor_referencesVer_value$$)
                    : "fh" == $attr_attributes$$
                    ? this.setHeight("100%")
                    : "l" == $attr_attributes$$
                    ? this.setLeft($element$jscomp$8_referencesHor_referencesVer_value$$)
                    : "r" == $attr_attributes$$
                    ? this.setRight($element$jscomp$8_referencesHor_referencesVer_value$$)
                    : "t" == $attr_attributes$$
                    ? this.setTop($element$jscomp$8_referencesHor_referencesVer_value$$)
                    : "b" == $attr_attributes$$
                    ? this.setBottom($element$jscomp$8_referencesHor_referencesVer_value$$)
                    : "al" == $attr_attributes$$
                    ? this.setAtLeft($element$jscomp$8_referencesHor_referencesVer_value$$)
                    : "ale" == $attr_attributes$$
                    ? (this.setAtLeft($element$jscomp$8_referencesHor_referencesVer_value$$),
                      this.setTop($element$jscomp$8_referencesHor_referencesVer_value$$),
                      this.setBottom($element$jscomp$8_referencesHor_referencesVer_value$$))
                    : "ar" == $attr_attributes$$
                    ? this.setAtRight($element$jscomp$8_referencesHor_referencesVer_value$$)
                    : "are" == $attr_attributes$$
                    ? (this.setAtRight($element$jscomp$8_referencesHor_referencesVer_value$$),
                      this.setTop($element$jscomp$8_referencesHor_referencesVer_value$$),
                      this.setBottom($element$jscomp$8_referencesHor_referencesVer_value$$))
                    : "at" == $attr_attributes$$
                    ? this.setAtTop($element$jscomp$8_referencesHor_referencesVer_value$$)
                    : "ate" == $attr_attributes$$
                    ? (this.setAtTop($element$jscomp$8_referencesHor_referencesVer_value$$),
                      this.setLeft($element$jscomp$8_referencesHor_referencesVer_value$$),
                      this.setRight($element$jscomp$8_referencesHor_referencesVer_value$$))
                    : "ab" == $attr_attributes$$
                    ? this.setAtBottom($element$jscomp$8_referencesHor_referencesVer_value$$)
                    : "abe" == $attr_attributes$$
                    ? (this.setAtBottom($element$jscomp$8_referencesHor_referencesVer_value$$),
                      this.setLeft($element$jscomp$8_referencesHor_referencesVer_value$$),
                      this.setRight($element$jscomp$8_referencesHor_referencesVer_value$$))
                    : "ml" == $attr_attributes$$
                    ? this.setMarginLeft($element$jscomp$8_referencesHor_referencesVer_value$$)
                    : "mr" == $attr_attributes$$
                    ? this.setMarginRight($element$jscomp$8_referencesHor_referencesVer_value$$)
                    : "mt" == $attr_attributes$$
                    ? this.setMarginTop($element$jscomp$8_referencesHor_referencesVer_value$$)
                    : "mb" == $attr_attributes$$
                    ? this.setMarginBottom($element$jscomp$8_referencesHor_referencesVer_value$$)
                    : "m" == $attr_attributes$$
                    ? (($attr_attributes$$ = $element$jscomp$8_referencesHor_referencesVer_value$$.split(",")),
                      1 == $attr_attributes$$.length
                          ? this.setMargins(
                                $element$jscomp$8_referencesHor_referencesVer_value$$,
                                $element$jscomp$8_referencesHor_referencesVer_value$$,
                                $element$jscomp$8_referencesHor_referencesVer_value$$,
                                $element$jscomp$8_referencesHor_referencesVer_value$$,
                            )
                          : 4 == $attr_attributes$$.length &&
                            this.setMargins($attr_attributes$$[0], $attr_attributes$$[1], $attr_attributes$$[2], $attr_attributes$$[3]))
                    : "pl" == $attr_attributes$$
                    ? this.setPaddingLeft($element$jscomp$8_referencesHor_referencesVer_value$$)
                    : "pr" == $attr_attributes$$
                    ? this.setPaddingRight($element$jscomp$8_referencesHor_referencesVer_value$$)
                    : "pt" == $attr_attributes$$
                    ? this.setPaddingTop($element$jscomp$8_referencesHor_referencesVer_value$$)
                    : "pb" == $attr_attributes$$
                    ? this.setPaddingBottom($element$jscomp$8_referencesHor_referencesVer_value$$)
                    : "p" == $attr_attributes$$
                    ? (($attr_attributes$$ = $element$jscomp$8_referencesHor_referencesVer_value$$.split(",")),
                      1 == $attr_attributes$$.length
                          ? this.setPaddings(
                          ...
                          : 4 == $attr_attributes$$.length &&
                            this.setPaddings($attr_attributes$$[0], $attr_attributes$$[1], $attr_attributes$$[2], $attr_attributes$$[3]))
                    : "cv" == $attr_attributes$$
                    ? this.setCenterVertical(!0)
                    : "ch" == $attr_attributes$$
                    ? this.setCenterHorizontal(!0)
                    : "c" == $attr_attributes$$
                    ? (this.setCenterVertical(!0), this.setCenterHorizontal(!0))
                    : "cui" == $attr_attributes$$
                    ? (this.childrenUI = "n" == $element$jscomp$8_referencesHor_referencesVer_value$$ ? !1 : !0)
                    : "sv" == $attr_attributes$$
                    ? this.setScrollVertical(!0)
                    : "sh" == $attr_attributes$$
                    ? this.setScrollHorizontal(!0)
                    : "v" == $attr_attributes$$
                    ? this.setVisibility($element$jscomp$8_referencesHor_referencesVer_value$$)
                    : 0 < $attr_attributes$$.length && logW("Attribute unknown: " + $attr_attributes$$ + " in view " + this.id)
        }
        $aValues$$ = !1
        $element$jscomp$8_referencesHor_referencesVer_value$$ = this.getReferencesHor()
        for (
            $attributeMain$jscomp$2_i$$ = 0;
            $attributeMain$jscomp$2_i$$ < $element$jscomp$8_referencesHor_referencesVer_value$$.length;
            $attributeMain$jscomp$2_i$$++
        ) {
            if (0 < $element$jscomp$8_referencesHor_referencesVer_value$$[$attributeMain$jscomp$2_i$$].length) {
                $aValues$$ = !0
                break
            }
        }
        $aValues$$ || this.centerHor || this.setLeft("p")
        $aValues$$ = !1
        $element$jscomp$8_referencesHor_referencesVer_value$$ = this.getReferencesVer()
        for (
            $attributeMain$jscomp$2_i$$ = 0;
            $attributeMain$jscomp$2_i$$ < $element$jscomp$8_referencesHor_referencesVer_value$$.length;
            $attributeMain$jscomp$2_i$$++
        ...
        $aValues$$ || this.centerVer || this.setTop("p")
    }
}
...
UIPrepare.prototype.orderViews = function $UIPrepare$$orderViews$($parent$$) {
    $parent$$.childrenInOrder ||
        ($parent$$.forEachChild(function($child$$, $index$$) {
            $child$$.dependenciesHor = []
            $child$$.dependenciesVer = []
        }),
        ($parent$$.childrenOrderHor = this.orderViewsSameParent($parent$$, !0)),
        ($parent$$.childrenOrderVer = this.orderViewsSameParent($parent$$, !1)),
        ($parent$$.childrenInOrder = !0))
    $parent$$.forEachChild(
        function($child$$, $index$$) {
...
UIPrepare.prototype.orderViewsSameParent = function $UIPrepare$$orderViewsSameParent$($parent$$, $hor$$) {
    ...
    0 == $numViewsSet$$ &&
        $parent$$.hasUIChildren() &&
        $views0dependencies$$ < $childElements$$.length &&
...
UIPrepare.prototype.loadSizes = function $UIPrepare$$loadSizes$($elements$$, $coreConfig$$, $forceSizeLoaded$$) {
    ...
    for (var $i$$ = 0; $i$$ < $elements$$.length; $i$$++) {
        var $ele$$ = $elements$$[$i$$],
            $view$$ = $ele$$.ui
        $view$$ &&
            $view$$.hasToBeCalculated() &&
            ("none" == $ele$$.style.display && ($ele$$.style.display = "inline-block"),
            !$view$$.hasToBeCalculated() ||
                (!$forceSizeLoaded$$ && $view$$.sizeLoaded) ||
                ("sc" != $view$$.sizeWidth || $view$$.hasUIChildren() || ($view$$.widthValue = UIViewUtilsInstance.calculateWidthView($view$$, $ele$$)),
                "sc" != $view$$.sizeHeight || $view$$.hasUIChildren() || ($view$$.heightValue = UIViewUtilsInstance.calculateHeightView($view$$, $ele$$)),
...
UIPrepare.prototype.loadSizeScreen = function $UIPrepare$$loadSizeScreen$($screen$$) {
    ...
    if ("sc" != $screen$$.sizeWidth) {
        "s" == $screen$$.sizeWidth
            ...
            : "sp" == $screen$$.sizeWidth && ($ele$$.style.width = $screen$$.widthValue + "%")
        var $offsetWidth$$ = $ele$$.offsetWidth
        $offsetWidth$$ != $screen$$.width && (($screen$$.width = $offsetWidth$$), ($sizeChanged$$ = !0))
    }
    "sc" != $screen$$.sizeHeight &&
        ("s" == $screen$$.sizeHeight
            ? ($ele$$.style.height = $screen$$.heightValue + "px")
            : "sp" == $screen$$.sizeWidth && ($ele$$.style.height = $screen$$.heightValue + "%"),
...
UIPrepare.prototype.generateUIView = function $UIPrepare$$generateUIView$($element$$, $parent$jscomp$7_view$$, $screen$$, $config$$) {
    return $element$$.ui
        ? $element$$.ui
        : null != $element$$.tagName && null != $element$$.getAttribute($config$$.attribute)
        ? (0 == $element$$.id.length && (($element$$.id = "_aID_" + this.generatedId), this.generatedId++),
          ($parent$jscomp$7_view$$ = new UIView($element$$, $parent$jscomp$7_view$$, $screen$$, $config$$.attribute, $config$$.attributes)),
          ($element$$.style.opacity = "0"),
          null != $element$$.tagName &&
              "img" == $element$$.tagName.toLowerCase() &&
              ($element$$.onload = function() {
                  $element$$.sizeLoaded = !1
                  this.refreshFunc()
              }.bind(this)),
          $parent$jscomp$7_view$$)
        : null
}
UIPrepare.prototype.generateUIViews = function $UIPrepare$$generateUIViews$($element$$, $config$$, $aScreens$$, $parentScreen$$, $parentElement_view$$) {
    $aScreens$$ || ($aScreens$$ = [])
    var $i$jscomp$17_index$jscomp$66_parent$$ = null,
        $screen$$ = null
    ...
    null != $parentElement_view$$ &&
        $parentElement_view$$.ui &&
        (($i$jscomp$17_index$jscomp$66_parent$$ = $element$$.parentNode.ui),
        ($screen$$ = $i$jscomp$17_index$jscomp$66_parent$$.screen ? $i$jscomp$17_index$jscomp$66_parent$$.screen : $i$jscomp$17_index$jscomp$66_parent$$))
    ;($parentElement_view$$ = this.generateUIView($element$$, $i$jscomp$17_index$jscomp$66_parent$$, $screen$$, $config$$)) &&
        !$i$jscomp$17_index$jscomp$66_parent$$ &&
        (($i$jscomp$17_index$jscomp$66_parent$$ = $aScreens$$.length),
        $parentScreen$$ && ($i$jscomp$17_index$jscomp$66_parent$$ = $aScreens$$.indexOf($parentScreen$$)),
        $aScreens$$.splice($i$jscomp$17_index$jscomp$66_parent$$, 0, $parentElement_view$$),
        ($parentScreen$$ = $parentElement_view$$),
        ($element$$.style.position = "relative"))
    for (
        $i$jscomp$17_index$jscomp$66_parent$$ = 0;
        $i$jscomp$17_index$jscomp$66_parent$$ < $element$$.childNodes.length;
        $i$jscomp$17_index$jscomp$66_parent$$++
    ) {
...
UIPrepare.prototype.addNodes = function $UIPrepare$$addNodes$($nodesAdded$$, $screens$$, $configuration$$) {
    for (var $countNodesAdded$$ = 0; 0 < $nodesAdded$$.length; ) {
        ...
        var $previousUIView$$ = UIUtilsInstance.getPreviousUIView($node$$),
            $previousUIScreen$$ = UIUtilsInstance.getPreviousUIScreen($previousUIView$$)
        this.generateUIViews($node$$, $configuration$$, $screens$$, $previousUIScreen$$)
        $previousUIView$$ && (($previousUIView$$.childrenInOrder = !1), $previousUIView$$.cleanSizeLoaded())
        $previousUIScreen$$ && $previousUIScreen$$.cleanSizeLoaded()
    }
...
UIPrepare.prototype.removeNodes = function $UIPrepare$$removeNodes$($parentNodesRemoved$$) {
    for (var $countNodesRemoved$$ = 0; 0 < $parentNodesRemoved$$.length; ) {
        ...
        var $refreshParent$$ = function $$refreshParent$$$($node$jscomp$4_parentNode$jscomp$2_view$$) {
            $node$jscomp$4_parentNode$jscomp$2_view$$ && $node$jscomp$4_parentNode$jscomp$2_view$$.ui
                ? (($node$jscomp$4_parentNode$jscomp$2_view$$ = $node$jscomp$4_parentNode$jscomp$2_view$$.ui),
                  ($node$jscomp$4_parentNode$jscomp$2_view$$.childrenInOrder = !1),
                  ("sc" != $node$jscomp$4_parentNode$jscomp$2_view$$.sizeWidth && "sc" != $node$jscomp$4_parentNode$jscomp$2_view$$.sizeHeight) ||
                      $node$jscomp$4_parentNode$jscomp$2_view$$.cleanSizeLoaded())
                : ($node$jscomp$4_parentNode$jscomp$2_view$$ = $node$jscomp$4_parentNode$jscomp$2_view$$.parentNode) &&
                  $refreshParent$$($node$jscomp$4_parentNode$jscomp$2_view$$)
        }
...
UIPrepare.prototype.updateNodes = function $UIPrepare$$updateNodes$($nodesUpdated$$, $screens$$, $configuration$$) {
    for (var $countNodesModified$$ = 0, $nodeIdsUpdated$$ = []; 0 < $nodesUpdated$$.length; ) {
        var $node$jscomp$5_previousUIScreen$jscomp$1_previousUIView$$ = $nodesUpdated$$[0]
        $nodesUpdated$$.splice(0, 1)
        var $view$$ = $node$jscomp$5_previousUIScreen$jscomp$1_previousUIView$$.ui
        if (!$view$$ || !$nodeIdsUpdated$$.includes($view$$.id)) {
            $countNodesModified$$ += 1
            if ($view$$) {
                $node$jscomp$5_previousUIScreen$jscomp$1_previousUIView$$.id != $view$$.id &&
                    ($view$$.id = $node$jscomp$5_previousUIScreen$jscomp$1_previousUIView$$.id),
                    $view$$.cleanUI(),
                    $view$$.readUI($view$$.element, $configuration$$.attribute, $configuration$$.attributes),
                    ($view$$.sizeLoaded = !1),
                    ($view$$.childrenInOrder = !1)
            } else {
                var $parent$jscomp$9_parentScreen$$ = UIUtilsInstance.getPreviousUIScreen($node$jscomp$5_previousUIScreen$jscomp$1_previousUIView$$)
                $view$$ = this.generateUIViews(
                    $node$jscomp$5_previousUIScreen$jscomp$1_previousUIView$$,
                    $configuration$$,
                    $screens$$,
                    $parent$jscomp$9_parentScreen$$,
                )
            }
            $view$$ &&
                ...
                ($parent$jscomp$9_parentScreen$$ = $view$$.parent)) &&
                (($parent$jscomp$9_parentScreen$$.childrenInOrder = !1), $parent$jscomp$9_parentScreen$$.cleanSizeLoaded())
            $node$jscomp$5_previousUIScreen$jscomp$1_previousUIView$$ = UIUtilsInstance.getPreviousUIView(
                $node$jscomp$5_previousUIScreen$jscomp$1_previousUIView$$,
            )
            ;($node$jscomp$5_previousUIScreen$jscomp$1_previousUIView$$ = UIUtilsInstance.getPreviousUIScreen(
                $node$jscomp$5_previousUIScreen$jscomp$1_previousUIView$$,
            )) && $node$jscomp$5_previousUIScreen$jscomp$1_previousUIView$$.cleanSizeLoaded()
        }
    }
...
UIDraw.prototype.applyPositions = function $UIDraw$$applyPositions$($parentView$$, $viewColors$$) {
    ...
    $parentView$$.forEachChild(
        function($childrenSize_view$$) {
            ...
            if (0 == $ele$$.childElementCount) {
                ...
                "sc" == $childrenSize_view$$.sizeWidth &&
                    (($paddingLeft$$ = parseInt($curStyle_left$$.paddingLeft, 10)), ($paddingRight$$ = parseInt($curStyle_left$$.paddingRight, 10)))
                "sc" == $childrenSize_view$$.sizeHeight &&
                    (($paddingTop$$ = parseInt($curStyle_left$$.paddingTop, 10)), ($paddingBottom$$ = parseInt($curStyle_left$$.paddingBottom, 10)))
            }
            ...
            var $top$$ = parseInt($childrenSize_view$$.top, 10),
                $width$$ = 0 < $childrenSize_view$$.width ? $childrenSize_view$$.width - $paddingLeft$$ - $paddingRight$$ : 0,
                $height$$ = 0 < $childrenSize_view$$.height ? $childrenSize_view$$.height - $paddingTop$$ - $paddingBottom$$ : 0
...
UIDraw.prototype.applyVisibility = function $UIDraw$$applyVisibility$($view$$, $parentView$$, $configuration$$, $forceGone$$) {
    ...
    var $ele$$ = $view$$.element,
        $opacityOld$$ = parseInt($ele$$.style.opacity, 10),
        $opacityNow$$ = $opacityOld$$
    "g" == $view$$.visibility || $forceGone$$
        ? (($ele$$.style.display = "none"), ($opacityNow$$ = 0))
        : (($ele$$.style.display = "inline-block"), ($opacityNow$$ = "i" == $view$$.visibility || ($parentView$$ && "i" == $parentView$$.visibility) ? 0 : 1))
    $configuration$$.animations.defaultOpacity &&
        $opacityNow$$ != $opacityOld$$ &&
...
UIDraw.prototype.applySizeScreen = function $UIDraw$$applySizeScreen$($screenView$$, $width$$, $height$$) {
    ...
    "s" != $screenView$$.id &&
        null != $ele$$ &&
        (($ele$$.style.width =
            "s" == $screenView$$.sizeWidth ? $screenView$$.width + "px" : "sp" == $screenView$$.sizeWidth ? $screenView$$.widthValue + "%" : $width$$ + "px"),
        ($ele$$.style.height =
            "s" == $screenView$$.sizeHeight
                ? $screenView$$.height + "px"
                : "sp" == $screenView$$.sizeHeight
                ? $screenView$$.heightValue + "%"
                : $height$$ + "px"))
}
...
UICore.prototype.calculateScreen = function $UICore$$calculateScreen$($screen$$) {
    var $arrayViews$$ = UIViewUtilsInstance.generateArrayViews($screen$$),
        $indexes$$ = UIViewUtilsInstance.generateIndexes($arrayViews$$)
    do {
        var $viewsRestored$$ = []
...
UICore.prototype.calculateViewHor = function $UICore$$calculateViewHor$($view$$, $parentView$$, $arrayViews$$, $indexes$$, $width$$, $viewsRestored$$) {
    for (var $numDependencies$$ = 0, $references$$ = $view$$.getReferencesHor(), $n$$ = 0; $n$$ < $references$$.length; $n$$++) {
        ...
        0 < $dependency$$.length &&
            (this.evalDependenceHor($view$$, $parentView$$, $width$$, $n$$, $arrayViews$$[$indexes$$[$dependency$$]]), ($numDependencies$$ += 1))
    }
    0 != $numDependencies$$ || $view$$.centerHor || (($view$$.left = 0), ($view$$.leftChanged = !0))
    ...
    $view$$.leftChanged && $view$$.rightChanged
        ? (this.assignSizeHor($view$$, $width$$),
          this.assignCenterHor($view$$, $width$$),
          0 < $view$$.childrenOrderHor.length &&
              (this.calculateViewsHor(
                  $view$$.childrenOrderHor,
                  $view$$,
                  $arrayViews$$,
                  $indexes$$,
                  $view$$.scrollHorizontal ? 0 : $view$$.width - $view$$.paddingLeft - $view$$.paddingRight,
                  $viewsRestored$$,
              ),
              this.applyPaddingChildrenHor($view$$)))
        : (0 < $view$$.childrenOrderHor.length
              ? (this.calculateViewsHor($view$$.childrenOrderHor, $view$$, $arrayViews$$, $indexes$$, 0, $viewsRestored$$),
                this.applyPaddingChildrenHor($view$$),
                this.applySizeChildrenHor($view$$, $arrayViews$$, $indexes$$, $viewsRestored$$))
              : this.applySizeContentHor($view$$),
          this.assignSizeHor($view$$, $width$$),
          this.assignCenterHor($view$$, $width$$))
    this.applyScrollHor($view$$, $width$$) &&
        (($view$$.paddingBottom += this.scrollWidth), ($view$$.scrollHorizontalApplied = !0), $viewsRestored$$.push($view$$))
}
...
UICore.prototype.calculateViewVer = function $UICore$$calculateViewVer$($view$$, $parentView$$, $arrayViews$$, $indexes$$, $height$$, $viewsRestored$$) {
    for (var $numDependencies$$ = 0, $references$$ = $view$$.getReferencesVer(), $n$$ = 0; $n$$ < $references$$.length; $n$$++) {
        var $dependency$$ = this.calculateViewDependency($view$$, $references$$[$n$$], $parentView$$)
        0 < $dependency$$.length &&
            (this.evalDependenceVer($view$$, $parentView$$, $height$$, $n$$, $arrayViews$$[$indexes$$[$dependency$$]]), ($numDependencies$$ += 1))
    }
    0 != $numDependencies$$ || $view$$.centerVer || (($view$$.top = 0), ($view$$.topChanged = !0))
    ...
    $view$$.topChanged && $view$$.bottomChanged
        ? (this.assignSizeVer($view$$, $height$$),
          this.assignCenterVer($view$$, $height$$),
          0 < $view$$.childrenOrderVer.length &&
              (this.calculateViewsVer(
                  $view$$.childrenOrderVer,
                  $view$$,
                  $arrayViews$$,
                  $indexes$$,
                  $view$$.scrollVertical ? 0 : $view$$.height - $view$$.paddingTop - $view$$.paddingBottom,
                  $viewsRestored$$,
              ),
        ...
        : (0 < $view$$.childrenOrderVer.length
          ...
          this.assignSizeVer($view$$, $height$$),
          this.assignCenterVer($view$$, $height$$))
    this.applyScrollVer($view$$, $height$$) &&
        (($view$$.paddingRight += this.scrollWidth), ($view$$.scrollVerticalApplied = !0), $viewsRestored$$.push($view$$))
}
...
UICore.prototype.applyFixedSizeHor = function $UICore$$applyFixedSizeHor$($view$$) {
    $view$$.rightChanged
        ? (($view$$.left = $view$$.right - $view$$.widthValue), ($view$$.leftChanged = !0))
        : (($view$$.right = $view$$.left + $view$$.widthValue), ($view$$.leftChanged = !0), ($view$$.rightChanged = !0))
}
UICore.prototype.applyFixedSizeVer = function $UICore$$applyFixedSizeVer$($view$$) {
    $view$$.bottomChanged
        ...
        : (($view$$.bottom = $view$$.top + $view$$.heightValue), ($view$$.topChanged = !0), ($view$$.bottomChanged = !0))
}
...
UICore.prototype.applySizeContentHor = function $UICore$$applySizeContentHor$($view$$) {
    $view$$.rightChanged
        ? (($view$$.left = $view$$.right - $view$$.widthValue), ($view$$.leftChanged = !0))
        : $view$$.leftChanged && (($view$$.right = $view$$.left + $view$$.widthValue), ($view$$.rightChanged = !0), ($view$$.leftChanged = !0))
}
UICore.prototype.applySizeContentVer = function $UICore$$applySizeContentVer$($view$$) {
    if ($view$$.bottomChanged) {
        ...
        if ($view$$.topChanged) {
            ...
            $view$$.centerVer && (($ele$$ = $view$$.element), ($ele$$.style.width = $view$$.width + "px"), ($view$$.heightValue = $ele$$.offsetHeight))
        }
    }
}
UICore.prototype.applySizeChildrenHor = function $UICore$$applySizeChildrenHor$($view$$, $arrayViews$$, $indexes$$, $viewsRestored$$) {
    ...
    $view$$.rightChanged
        ...
        : (($view$$.right = $view$$.left + $widthChildren$$ + $view$$.paddingRight), ($view$$.rightChanged = !0))
    $view$$.leftChanged = !0
    $view$$.width = $view$$.right - $view$$.left
    $view$$.forEachChild(function($child$$) {
...
UICore.prototype.applySizeChildrenVer = function $UICore$$applySizeChildrenVer$($view$$, $arrayViews$$, $indexes$$, $viewsRestored$$) {
    ...
    $view$$.bottomChanged
        ? (($view$$.top = $view$$.bottom - $heightChildren$$ - $view$$.paddingTop), ($view$$.topChanged = !0))
        : (($view$$.bottom = $view$$.top + $heightChildren$$ + $view$$.paddingBottom), ($view$$.bottomChanged = !0))
    $view$$.height = $view$$.bottom - $view$$.top
    $view$$.forEachChild(function($child$$) {
...
UICore.prototype.applyPercentHor = function $UICore$$applyPercentHor$($view$$, $parentView$$, $width$$) {
    $view$$.rightChanged && !$view$$.leftChanged
        ? ($view$$.left = $view$$.right - ($parentView$$.width * $view$$.widthValue) / 100)
        : ($view$$.right = $view$$.left + ($parentView$$.width * $view$$.widthValue) / 100)
    0 < $view$$.percentWidthPos &&
        (($parentView$$ = ($view$$.right - $view$$.left) * $view$$.percentWidthPos), ($view$$.left += $parentView$$), ($view$$.right += $parentView$$))
    $view$$.rightChanged = !0
    $view$$.leftChanged = !0
}
UICore.prototype.applyPercentVer = function $UICore$$applyPercentVer$($view$$, $parentView$$, $height$$) {
    $view$$.bottomChanged && !$view$$.topChanged
        ? ($view$$.top = $view$$.bottom - ($parentView$$.height * $view$$.heightValue) / 100)
        : ($view$$.bottom = $view$$.top + ($parentView$$.height * $view$$.heightValue) / 100)
    0 < $view$$.percentHeightPos &&
        (($parentView$$ = ($view$$.bottom - $view$$.top) * $view$$.percentHeightPos), ($view$$.top += $parentView$$), ($view$$.bottom += $parentView$$))
    $view$$.bottomChanged = !0
    $view$$.topChanged = !0
}
UICore.prototype.assignCenterHor = function $UICore$$assignCenterHor$($view$$, $width$$) {
    if ($view$$.centerHor && 0 < $width$$) {
...
UICore.prototype.assignCenterVer = function $UICore$$assignCenterVer$($view$$, $height$$) {
    if ($view$$.centerVer && 0 < $height$$) {
...
UICore.prototype.assignMarginsHor = function $UICore$$assignMarginsHor$($view$$) {
    var $viewMarginLeft$$ = $view$$.marginLeft,
        $viewMarginRight$$ = $view$$.marginRight
    0 != $viewMarginLeft$$ &&
        $view$$.leftChanged &&
        (($view$$.left += $viewMarginLeft$$), ($view$$.rightChanged && "s" != $view$$.sizeWidth) || ($view$$.right += $viewMarginLeft$$))
    0 != $viewMarginRight$$ &&
        $view$$.rightChanged &&
        (($view$$.right -= $viewMarginRight$$), ($view$$.leftChanged && "s" != $view$$.sizeWidth) || ($view$$.left -= $viewMarginRight$$))
}
UICore.prototype.assignMarginsVer = function $UICore$$assignMarginsVer$($view$$) {
    ...
    0 != $view$$.marginTop &&
        $view$$.topChanged &&
        (($view$$.top += $viewMarginTop$$), ($view$$.bottomChanged && "s" != $view$$.sizeHeight) || ($view$$.bottom += $viewMarginTop$$))
    0 != $view$$.marginBottom &&
        $view$$.bottomChanged &&
        (($view$$.bottom -= $viewMarginBottom$$), ($view$$.topChanged && "s" != $view$$.sizeHeight) || ($view$$.top -= $viewMarginBottom$$))
}
...
UICore.prototype.calculateViewDependency = function $UICore$$calculateViewDependency$($previousView$jscomp$1_view$$, $viewDependency$$, $parentView$$) {
    return "p" == $viewDependency$$
        ? $parentView$$.id
        : "l" == $viewDependency$$
        ? (($previousView$jscomp$1_view$$ = $previousView$jscomp$1_view$$.getPreviousView()),
          null == $previousView$jscomp$1_view$$ ? "" : $previousView$jscomp$1_view$$.id)
        : $viewDependency$$
}
...
function WebUI() {
    ...
    this.redraw = function() {
        var $countNodesAdded$$ = this.uiPrepare.addNodes(this.nodesAdded, this.screens, this.configuration),
            $countNodesRemoved$$ = this.uiPrepare.removeNodes(this.parentNodesRemoved),
            $countNodesModified$$ = this.uiPrepare.updateNodes(this.nodesUpdated, this.screens, this.configuration)
...
WebUI.prototype.listenDomEvents = function $WebUI$$listenDomEvents$() {
    ...
    var $callback$$ = function($$jscomp$iter$0_mutationsList$$) {
        ...
        for (
            var $$jscomp$key$mutation_mutation$$ = $$jscomp$iter$0_mutationsList$$.next();
            !$$jscomp$key$mutation_mutation$$.done;
            $$jscomp$key$mutation_mutation$$ = $$jscomp$iter$0_mutationsList$$.next()
        ) {
            if ((($$jscomp$key$mutation_mutation$$ = $$jscomp$key$mutation_mutation$$.value), "childList" == $$jscomp$key$mutation_mutation$$.type)) {
                for (
                    var $attributeName$jscomp$1_i$$ = 0;
                    $attributeName$jscomp$1_i$$ < $$jscomp$key$mutation_mutation$$.addedNodes.length;
                    $attributeName$jscomp$1_i$$++
                ) {
                    this.nodesAdded.push($$jscomp$key$mutation_mutation$$.addedNodes[$attributeName$jscomp$1_i$$])
                }
                for (
                    $attributeName$jscomp$1_i$$ = 0;
                    $attributeName$jscomp$1_i$$ < $$jscomp$key$mutation_mutation$$.removedNodes.length;
                    $attributeName$jscomp$1_i$$++
                ) {
                ...
                if ("attributes" == $$jscomp$key$mutation_mutation$$.type) {
                    if (
                        (($attributeName$jscomp$1_i$$ = $$jscomp$key$mutation_mutation$$.attributeName),
                        "id" == $attributeName$jscomp$1_i$$ ||
                            "class" == $attributeName$jscomp$1_i$$ ||
                            $attributeName$jscomp$1_i$$ == this.configuration.attribute ||
                            this.configuration.attributes.includes($attributeName$jscomp$1_i$$))
                    ) {
                        this.nodesUpdated.push($$jscomp$key$mutation_mutation$$.target), this.redraw()
                    }
                } else {
                    "characterData" == $$jscomp$key$mutation_mutation$$.type &&
                        ($$jscomp$key$mutation_mutation$$.target.parentNode && this.nodesUpdated.push($$jscomp$key$mutation_mutation$$.target.parentNode),
                        this.redraw())
                }
            }
        }
    }.bind(this)
    new MutationObserver($callback$$).observe($bodyElement$$, { characterData: !0, attributes: !0, childList: !0, subtree: !0 })
}
...
WebUI.prototype.drawUIScreen = function $WebUI$$drawUIScreen$($screen$$) {
    var $screenSizeChanged_timerLoadSizes$$ = 0,
        $timerOrderViews$$ = 0,
        $timerPrepare$$ = 0,
        $timerCore$$ = 0
    startCounter("all")
    ...
    $screen$$.hasToBeCalculated() &&
        (($screenSizeChanged_timerLoadSizes$$ = this.uiPrepare.loadSizeScreen($screen$$)),
        this.uiPrepare.loadSizes($screen$$.getChildElements(), this.configuration, $screenSizeChanged_timerLoadSizes$$),
        ($screenSizeChanged_timerLoadSizes$$ = endCounter("loadSizes")),
    ...
    log(
        "[" +
            ...
            $timerCore$$ +
            "ms - Draw: " +
            $childrenSizes_timerDraw$$ +
            "ms - LoadSizes: " +
            $screenSizeChanged_timerLoadSizes$$ +
            "ms - OrderViews: " +
            $timerOrderViews$$ +
            "ms",
    )
