...
![WebUI example](https://github.com/SilicorniO/webui/blob/master/resources/webui_presentation.gif)
...
<html>
    <head>
        ...
        <script type="text/javascript" src="js-webui-1.0.8.min.js"></script>
    </head>
    <body></body>
</html>
```
